var SimpleQuest=(function(C){"use strict";var Yo=Object.defineProperty;var $t=C=>{throw TypeError(C)};var zo=(C,S,Y)=>S in C?Yo(C,S,{enumerable:!0,configurable:!0,writable:!0,value:Y}):C[S]=Y;var b=(C,S,Y)=>zo(C,typeof S!="symbol"?S+"":S,Y),Oo=(C,S,Y)=>S.has(C)||$t("Cannot "+Y);var qt=(C,S,Y)=>S.has(C)?$t("Cannot add the same private member more than once"):S instanceof WeakSet?S.add(C):S.set(C,Y);var qe=(C,S,Y)=>(Oo(C,S,"access private method"),Y);var Q,Qe,Et;const Y=(n,e)=>n===e,F=Symbol("solid-proxy"),Ee=Symbol("solid-track"),he={equals:Y};let Ve=tt;const M=1,fe=2,Xe={owned:null,cleanups:null,context:null,owner:null};var T=null;let Ye=null,Yt=null,x=null,R=null,L=null,pe=0;function ge(n,e){const t=x,o=T,a=n.length===0,r=e===void 0?o:e,i=a?Xe:{owned:null,cleanups:null,context:r?r.context:null,owner:r},s=a?n:()=>n(()=>G(()=>ne(i)));T=i,x=null;try{return X(s,!0)}finally{x=t,T=o}}function V(n,e){e=e?Object.assign({},he,e):he;const t={value:n,observers:null,observerSlots:null,comparator:e.equals||void 0},o=a=>(typeof a=="function"&&(a=a(t.value)),et(t,a));return[Je.bind(t),o]}function A(n,e,t){const o=Oe(n,e,!1,M);te(o)}function ye(n,e,t){Ve=Lt;const o=Oe(n,e,!1,M);o.user=!0,L?L.push(o):te(o)}function H(n,e,t){t=t?Object.assign({},he,t):he;const o=Oe(n,e,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=t.equals||void 0,te(o),Je.bind(o)}function zt(n){return X(n,!1)}function G(n){if(x===null)return n();const e=x;x=null;try{return n()}finally{x=e}}function Ot(n){ye(()=>G(n))}function It(n){return T===null||(T.cleanups===null?T.cleanups=[n]:T.cleanups.push(n)),n}function ze(){return x}function Je(){if(this.sources&&this.state)if(this.state===M)te(this);else{const n=R;R=null,X(()=>be(this),!1),R=n}if(x){const n=this.observers?this.observers.length:0;x.sources?(x.sources.push(this),x.sourceSlots.push(n)):(x.sources=[this],x.sourceSlots=[n]),this.observers?(this.observers.push(x),this.observerSlots.push(x.sources.length-1)):(this.observers=[x],this.observerSlots=[x.sources.length-1])}return this.value}function et(n,e,t){let o=n.value;return(!n.comparator||!n.comparator(o,e))&&(n.value=e,n.observers&&n.observers.length&&X(()=>{for(let a=0;a<n.observers.length;a+=1){const r=n.observers[a],i=Ye&&Ye.running;i&&Ye.disposed.has(r),(i?!r.tState:!r.state)&&(r.pure?R.push(r):L.push(r),r.observers&&nt(r)),i||(r.state=M)}if(R.length>1e6)throw R=[],new Error},!1)),e}function te(n){if(!n.fn)return;ne(n);const e=pe;Pt(n,n.value,e)}function Pt(n,e,t){let o;const a=T,r=x;x=T=n;try{o=n.fn(e)}catch(i){return n.pure&&(n.state=M,n.owned&&n.owned.forEach(ne),n.owned=null),n.updatedAt=t+1,ot(i)}finally{x=r,T=a}(!n.updatedAt||n.updatedAt<=t)&&(n.updatedAt!=null&&"observers"in n?et(n,o):n.value=o,n.updatedAt=t)}function Oe(n,e,t,o=M,a){const r={fn:n,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:e,owner:T,context:T?T.context:null,pure:t};return T===null||T!==Xe&&(T.owned?T.owned.push(r):T.owned=[r]),r}function me(n){if(n.state===0)return;if(n.state===fe)return be(n);if(n.suspense&&G(n.suspense.inFallback))return n.suspense.effects.push(n);const e=[n];for(;(n=n.owner)&&(!n.updatedAt||n.updatedAt<pe);)n.state&&e.push(n);for(let t=e.length-1;t>=0;t--)if(n=e[t],n.state===M)te(n);else if(n.state===fe){const o=R;R=null,X(()=>be(n,e[0]),!1),R=o}}function X(n,e){if(R)return n();let t=!1;e||(R=[]),L?t=!0:L=[],pe++;try{const o=n();return Nt(t),o}catch(o){t||(L=null),R=null,ot(o)}}function Nt(n){if(R&&(tt(R),R=null),n)return;const e=L;L=null,e.length&&X(()=>Ve(e),!1)}function tt(n){for(let e=0;e<n.length;e++)me(n[e])}function Lt(n){let e,t=0;for(e=0;e<n.length;e++){const o=n[e];o.user?n[t++]=o:me(o)}for(e=0;e<t;e++)me(n[e])}function be(n,e){n.state=0;for(let t=0;t<n.sources.length;t+=1){const o=n.sources[t];if(o.sources){const a=o.state;a===M?o!==e&&(!o.updatedAt||o.updatedAt<pe)&&me(o):a===fe&&be(o,e)}}}function nt(n){for(let e=0;e<n.observers.length;e+=1){const t=n.observers[e];t.state||(t.state=fe,t.pure?R.push(t):L.push(t),t.observers&&nt(t))}}function ne(n){let e;if(n.sources)for(;n.sources.length;){const t=n.sources.pop(),o=n.sourceSlots.pop(),a=t.observers;if(a&&a.length){const r=a.pop(),i=t.observerSlots.pop();o<a.length&&(r.sourceSlots[i]=o,a[o]=r,t.observerSlots[o]=i)}}if(n.tOwned){for(e=n.tOwned.length-1;e>=0;e--)ne(n.tOwned[e]);delete n.tOwned}if(n.owned){for(e=n.owned.length-1;e>=0;e--)ne(n.owned[e]);n.owned=null}if(n.cleanups){for(e=n.cleanups.length-1;e>=0;e--)n.cleanups[e]();n.cleanups=null}n.state=0}function jt(n){return n instanceof Error?n:new Error(typeof n=="string"?n:"Unknown error",{cause:n})}function ot(n,e=T){throw jt(n)}const Mt=Symbol("fallback");function at(n){for(let e=0;e<n.length;e++)n[e]()}function Ht(n,e,t={}){let o=[],a=[],r=[],i=0,s=e.length>1?[]:null;return It(()=>at(r)),()=>{let l=n()||[],c=l.length,u,d;return l[Ee],G(()=>{let h,k,v,D,B,q,E,z,N;if(c===0)i!==0&&(at(r),r=[],o=[],a=[],i=0,s&&(s=[])),t.fallback&&(o=[Mt],a[0]=ge(Eo=>(r[0]=Eo,t.fallback())),i=1);else if(i===0){for(a=new Array(c),d=0;d<c;d++)o[d]=l[d],a[d]=ge(f);i=c}else{for(v=new Array(c),D=new Array(c),s&&(B=new Array(c)),q=0,E=Math.min(i,c);q<E&&o[q]===l[q];q++);for(E=i-1,z=c-1;E>=q&&z>=q&&o[E]===l[z];E--,z--)v[z]=a[E],D[z]=r[E],s&&(B[z]=s[E]);for(h=new Map,k=new Array(z+1),d=z;d>=q;d--)N=l[d],u=h.get(N),k[d]=u===void 0?-1:u,h.set(N,d);for(u=q;u<=E;u++)N=o[u],d=h.get(N),d!==void 0&&d!==-1?(v[d]=a[u],D[d]=r[u],s&&(B[d]=s[u]),d=k[d],h.set(N,d)):r[u]();for(d=q;d<c;d++)d in v?(a[d]=v[d],r[d]=D[d],s&&(s[d]=B[d],s[d](d))):a[d]=ge(f);a=a.slice(0,i=c),o=l.slice(0)}return a});function f(h){if(r[d]=h,s){const[k,v]=V(d);return s[d]=v,e(l[d],k)}return e(l[d])}}}function m(n,e){return G(()=>n(e||{}))}const Bt=n=>`Stale read from <${n}>.`;function U(n){const e="fallback"in n&&{fallback:()=>n.fallback};return H(Ht(()=>n.each,n.children,e||void 0))}function oe(n){const e=n.keyed,t=H(()=>n.when,void 0,void 0),o=e?t:H(t,void 0,{equals:(a,r)=>!a==!r});return H(()=>{const a=o();if(a){const r=n.children;return typeof r=="function"&&r.length>0?G(()=>r(e?a:()=>{if(!G(o))throw Bt("Show");return t()})):r}return n.fallback},void 0,void 0)}const O=n=>H(()=>n());function Ft(n,e,t){let o=t.length,a=e.length,r=o,i=0,s=0,l=e[a-1].nextSibling,c=null;for(;i<a||s<r;){if(e[i]===t[s]){i++,s++;continue}for(;e[a-1]===t[r-1];)a--,r--;if(a===i){const u=r<o?s?t[s-1].nextSibling:t[r-s]:l;for(;s<r;)n.insertBefore(t[s++],u)}else if(r===s)for(;i<a;)(!c||!c.has(e[i]))&&e[i].remove(),i++;else if(e[i]===t[r-1]&&t[s]===e[a-1]){const u=e[--a].nextSibling;n.insertBefore(t[s++],e[i++].nextSibling),n.insertBefore(t[--r],u),e[a]=t[r]}else{if(!c){c=new Map;let d=s;for(;d<r;)c.set(t[d],d++)}const u=c.get(e[i]);if(u!=null)if(s<u&&u<r){let d=i,f=1,h;for(;++d<a&&d<r&&!((h=c.get(e[d]))==null||h!==u+f);)f++;if(f>u-s){const k=e[i];for(;s<u;)n.insertBefore(t[s++],k)}else n.replaceChild(t[s++],e[i++])}else i++;else e[i++].remove()}}}const rt="_$DX_DELEGATE";function w(n,e,t,o){let a;const r=()=>{const s=document.createElement("template");return s.innerHTML=n,s.content.firstChild},i=()=>(a||(a=r())).cloneNode(!0);return i.cloneNode=i,i}function W(n,e=window.document){const t=e[rt]||(e[rt]=new Set);for(let o=0,a=n.length;o<a;o++){const r=n[o];t.has(r)||(t.add(r),e.addEventListener(r,Ut))}}function Gt(n,e,t){n.removeAttribute(e)}function Ie(n,e,t,o){Array.isArray(t)?(n[`$$${e}`]=t[0],n[`$$${e}Data`]=t[1]):n[`$$${e}`]=t}function we(n,e,t){if(!e)return t?Gt(n,"style"):e;const o=n.style;if(typeof e=="string")return o.cssText=e;typeof t=="string"&&(o.cssText=t=void 0),t||(t={}),e||(e={});let a,r;for(r in t)e[r]==null&&o.removeProperty(r),delete t[r];for(r in e)a=e[r],a!==t[r]&&(o.setProperty(r,a),t[r]=a);return t}function _(n,e,t){t!=null?n.style.setProperty(e,t):n.style.removeProperty(e)}function p(n,e,t,o){if(t!==void 0&&!o&&(o=[]),typeof e!="function")return ke(n,e,o,t);A(a=>ke(n,e(),a,t),o)}function Ut(n){let e=n.target;const t=`$$${n.type}`,o=n.target,a=n.currentTarget,r=l=>Object.defineProperty(n,"target",{configurable:!0,value:l}),i=()=>{const l=e[t];if(l&&!e.disabled){const c=e[`${t}Data`];if(c!==void 0?l.call(e,c,n):l.call(e,n),n.cancelBubble)return}return e.host&&typeof e.host!="string"&&!e.host._$host&&e.contains(n.target)&&r(e.host),!0},s=()=>{for(;i()&&(e=e._$host||e.parentNode||e.host););};if(Object.defineProperty(n,"currentTarget",{configurable:!0,get(){return e||document}}),n.composedPath){const l=n.composedPath();r(l[0]);for(let c=0;c<l.length-2&&(e=l[c],!!i());c++){if(e._$host){e=e._$host,s();break}if(e.parentNode===a)break}}else s();r(o)}function ke(n,e,t,o,a){for(;typeof t=="function";)t=t();if(e===t)return t;const r=typeof e,i=o!==void 0;if(n=i&&t[0]&&t[0].parentNode||n,r==="string"||r==="number"){if(r==="number"&&(e=e.toString(),e===t))return t;if(i){let s=t[0];s&&s.nodeType===3?s.data!==e&&(s.data=e):s=document.createTextNode(e),t=J(n,t,o,s)}else t!==""&&typeof t=="string"?t=n.firstChild.data=e:t=n.textContent=e}else if(e==null||r==="boolean")t=J(n,t,o);else{if(r==="function")return A(()=>{let s=e();for(;typeof s=="function";)s=s();t=ke(n,s,t,o)}),()=>t;if(Array.isArray(e)){const s=[],l=t&&Array.isArray(t);if(Pe(s,e,t,a))return A(()=>t=ke(n,s,t,o,!0)),()=>t;if(s.length===0){if(t=J(n,t,o),i)return t}else l?t.length===0?it(n,s,o):Ft(n,t,s):(t&&J(n),it(n,s));t=s}else if(e.nodeType){if(Array.isArray(t)){if(i)return t=J(n,t,o,e);J(n,t,null,e)}else t==null||t===""||!n.firstChild?n.appendChild(e):n.replaceChild(e,n.firstChild);t=e}}return t}function Pe(n,e,t,o){let a=!1;for(let r=0,i=e.length;r<i;r++){let s=e[r],l=t&&t[n.length],c;if(!(s==null||s===!0||s===!1))if((c=typeof s)=="object"&&s.nodeType)n.push(s);else if(Array.isArray(s))a=Pe(n,s,l)||a;else if(c==="function")if(o){for(;typeof s=="function";)s=s();a=Pe(n,Array.isArray(s)?s:[s],Array.isArray(l)?l:[l])||a}else n.push(s),a=!0;else{const u=String(s);l&&l.nodeType===3&&l.data===u?n.push(l):n.push(document.createTextNode(u))}}return a}function it(n,e,t=null){for(let o=0,a=e.length;o<a;o++)n.insertBefore(e[o],t)}function J(n,e,t,o){if(t===void 0)return n.textContent="";const a=o||document.createTextNode("");if(e.length){let r=!1;for(let i=e.length-1;i>=0;i--){const s=e[i];if(a!==s){const l=s.parentNode===n;!r&&!i?l?n.replaceChild(a,s):n.insertBefore(a,t):l&&s.remove()}else r=!0}}else n.insertBefore(a,t);return[a]}function Wt(n){return Object.keys(n).reduce((t,o)=>{const a=n[o];return t[o]=Object.assign({},a),ct(a.value)&&!Xt(a.value)&&!Array.isArray(a.value)&&(t[o].value=Object.assign({},a.value)),Array.isArray(a.value)&&(t[o].value=a.value.slice(0)),t},{})}function Zt(n){return n?Object.keys(n).reduce((t,o)=>{const a=n[o];return t[o]=ct(a)&&"value"in a?a:{value:a},t[o].attribute||(t[o].attribute=Vt(o)),t[o].parse="parse"in t[o]?t[o].parse:typeof t[o].value!="string",t},{}):{}}function Kt(n){return Object.keys(n).reduce((t,o)=>(t[o]=n[o].value,t),{})}function Qt(n,e){const t=Wt(e);return Object.keys(e).forEach(a=>{const r=t[a],i=n.getAttribute(r.attribute),s=n[a];i!=null&&(r.value=r.parse?st(i):i),s!=null&&(r.value=Array.isArray(s)?s.slice(0):s),r.reflect&&lt(n,r.attribute,r.value,!!r.parse),Object.defineProperty(n,a,{get(){return r.value},set(l){const c=r.value;r.value=l,r.reflect&&lt(this,r.attribute,r.value,!!r.parse);for(let u=0,d=this.__propertyChangedCallbacks.length;u<d;u++)this.__propertyChangedCallbacks[u](a,l,c)},enumerable:!0,configurable:!0})}),t}function st(n){if(n)try{return JSON.parse(n)}catch{return n}}function lt(n,e,t,o){if(t==null||t===!1)return n.removeAttribute(e);let a=o?JSON.stringify(t):t;n.__updating[e]=!0,a==="true"&&(a=""),n.setAttribute(e,a),Promise.resolve().then(()=>delete n.__updating[e])}function Vt(n){return n.replace(/\.?([A-Z]+)/g,(e,t)=>"-"+t.toLowerCase()).replace("_","-").replace(/^-/,"")}function ct(n){return n!=null&&(typeof n=="object"||typeof n=="function")}function Xt(n){return Object.prototype.toString.call(n)==="[object Function]"}function Jt(n){return typeof n=="function"&&n.toString().indexOf("class")===0}let Ne;function en(n,e){const t=Object.keys(e);return class extends n{static get observedAttributes(){return t.map(a=>e[a].attribute)}constructor(){super(),this.__initialized=!1,this.__released=!1,this.__releaseCallbacks=[],this.__propertyChangedCallbacks=[],this.__updating={},this.props={};for(let a of t)this[a]=void 0}connectedCallback(){if(this.__initialized)return;this.__releaseCallbacks=[],this.__propertyChangedCallbacks=[],this.__updating={},this.props=Qt(this,e);const a=Kt(this.props),r=this.Component,i=Ne;try{Ne=this,this.__initialized=!0,Jt(r)?new r(a,{element:this}):r(a,{element:this})}finally{Ne=i}}async disconnectedCallback(){if(await Promise.resolve(),this.isConnected)return;this.__propertyChangedCallbacks.length=0;let a=null;for(;a=this.__releaseCallbacks.pop();)a(this);delete this.__initialized,this.__released=!0}attributeChangedCallback(a,r,i){if(this.__initialized&&!this.__updating[a]&&(a=this.lookupProp(a),a in e)){if(i==null&&!this[a])return;this[a]=e[a].parse?st(i):i}}lookupProp(a){if(e)return t.find(r=>a===r||a===e[r].attribute)}get renderRoot(){return this.shadowRoot||this.attachShadow({mode:"open"})}addReleaseCallback(a){this.__releaseCallbacks.push(a)}addPropertyChangedCallback(a){this.__propertyChangedCallbacks.push(a)}}}function tn(n,e={},t={}){const{BaseElement:o=HTMLElement,extension:a,customElements:r=window.customElements}=t;return i=>{let s=r.get(n);return s?(s.prototype.Component=i,s):(s=en(o,Zt(e)),s.prototype.Component=i,s.prototype.registeredTag=n,r.define(n,s,a),s)}}function nn(n){const e=Object.keys(n),t={};for(let o=0;o<e.length;o++){const[a,r]=V(n[e[o]]);Object.defineProperty(t,e[o],{get:a,set(i){r(()=>i)}})}return t}function on(n){if(n.assignedSlot&&n.assignedSlot._$owner)return n.assignedSlot._$owner;let e=n.parentNode;for(;e&&!e._$owner&&!(e.assignedSlot&&e.assignedSlot._$owner);)e=e.parentNode;return e&&e.assignedSlot?e.assignedSlot._$owner:n._$owner}function an(n){return(e,t)=>{const{element:o}=t;return ge(a=>{const r=nn(e);o.addPropertyChangedCallback((s,l)=>r[s]=l),o.addReleaseCallback(()=>{o.renderRoot.textContent="",a()});const i=n(r,t);return p(o.renderRoot,i)},on(o))}}function rn(n,e,t){return arguments.length===2&&(t=e,e={}),tn(n,e)(an(t))}const Le=Symbol("store-raw"),ee=Symbol("store-node"),j=Symbol("store-has"),ut=Symbol("store-self");function dt(n){let e=n[F];if(!e&&(Object.defineProperty(n,F,{value:e=new Proxy(n,cn)}),!Array.isArray(n))){const t=Object.keys(n),o=Object.getOwnPropertyDescriptors(n);for(let a=0,r=t.length;a<r;a++){const i=t[a];o[i].get&&Object.defineProperty(n,i,{enumerable:o[i].enumerable,get:o[i].get.bind(e)})}}return e}function ve(n){let e;return n!=null&&typeof n=="object"&&(n[F]||!(e=Object.getPrototypeOf(n))||e===Object.prototype||Array.isArray(n))}function ae(n,e=new Set){let t,o,a,r;if(t=n!=null&&n[Le])return t;if(!ve(n)||e.has(n))return n;if(Array.isArray(n)){Object.isFrozen(n)?n=n.slice(0):e.add(n);for(let i=0,s=n.length;i<s;i++)a=n[i],(o=ae(a,e))!==a&&(n[i]=o)}else{Object.isFrozen(n)?n=Object.assign({},n):e.add(n);const i=Object.keys(n),s=Object.getOwnPropertyDescriptors(n);for(let l=0,c=i.length;l<c;l++)r=i[l],!s[r].get&&(a=n[r],(o=ae(a,e))!==a&&(n[r]=o))}return n}function xe(n,e){let t=n[e];return t||Object.defineProperty(n,e,{value:t=Object.create(null)}),t}function re(n,e,t){if(n[e])return n[e];const[o,a]=V(t,{equals:!1,internal:!0});return o.$=a,n[e]=o}function sn(n,e){const t=Reflect.getOwnPropertyDescriptor(n,e);return!t||t.get||!t.configurable||e===F||e===ee||(delete t.value,delete t.writable,t.get=()=>n[F][e]),t}function ht(n){ze()&&re(xe(n,ee),ut)()}function ln(n){return ht(n),Reflect.ownKeys(n)}const cn={get(n,e,t){if(e===Le)return n;if(e===F)return t;if(e===Ee)return ht(n),t;const o=xe(n,ee),a=o[e];let r=a?a():n[e];if(e===ee||e===j||e==="__proto__")return r;if(!a){const i=Object.getOwnPropertyDescriptor(n,e);ze()&&(typeof r!="function"||n.hasOwnProperty(e))&&!(i&&i.get)&&(r=re(o,e,r)())}return ve(r)?dt(r):r},has(n,e){return e===Le||e===F||e===Ee||e===ee||e===j||e==="__proto__"?!0:(ze()&&re(xe(n,j),e)(),e in n)},set(){return!0},deleteProperty(){return!0},ownKeys:ln,getOwnPropertyDescriptor:sn};function _e(n,e,t,o=!1){if(!o&&n[e]===t)return;const a=n[e],r=n.length;t===void 0?(delete n[e],n[j]&&n[j][e]&&a!==void 0&&n[j][e].$()):(n[e]=t,n[j]&&n[j][e]&&a===void 0&&n[j][e].$());let i=xe(n,ee),s;if((s=re(i,e,a))&&s.$(()=>t),Array.isArray(n)&&n.length!==r){for(let l=n.length;l<r;l++)(s=i[l])&&s.$();(s=re(i,"length",r))&&s.$(n.length)}(s=i[ut])&&s.$()}function ft(n,e){const t=Object.keys(e);for(let o=0;o<t.length;o+=1){const a=t[o];_e(n,a,e[a])}}function un(n,e){if(typeof e=="function"&&(e=e(n)),e=ae(e),Array.isArray(e)){if(n===e)return;let t=0,o=e.length;for(;t<o;t++){const a=e[t];n[t]!==a&&_e(n,t,a)}_e(n,"length",o)}else ft(n,e)}function ie(n,e,t=[]){let o,a=n;if(e.length>1){o=e.shift();const i=typeof o,s=Array.isArray(n);if(Array.isArray(o)){for(let l=0;l<o.length;l++)ie(n,[o[l]].concat(e),t);return}else if(s&&i==="function"){for(let l=0;l<n.length;l++)o(n[l],l)&&ie(n,[l].concat(e),t);return}else if(s&&i==="object"){const{from:l=0,to:c=n.length-1,by:u=1}=o;for(let d=l;d<=c;d+=u)ie(n,[d].concat(e),t);return}else if(e.length>1){ie(n[o],e,[o].concat(t));return}a=n[o],t=[o].concat(t)}let r=e[0];typeof r=="function"&&(r=r(a,t),r===a)||o===void 0&&r==null||(r=ae(r),o===void 0||ve(a)&&ve(r)&&!Array.isArray(r)?ft(a,r):_e(n,o,r))}function dn(...[n,e]){const t=ae(n||{}),o=Array.isArray(t),a=dt(t);function r(...i){zt(()=>{o&&i.length===1?un(t,i[0]):ie(t,i)})}return[a,r]}const pt="simplequest-characters",hn={name:"",personality:"",class:"",profession:"",combat:"inGeneral",energy:Array(10).fill(!1),hp:10,die:"d6",round:0,usedAbilities:[],selectedAbility:null,gmMode:!1,savedCharacters:{}};function fn(){const[n,e]=dn(structuredClone(hn));function t(i){e("energy",s=>s.map((l,c)=>c<=i))}function o(){try{const i=localStorage.getItem(pt);i&&e("savedCharacters",JSON.parse(i))}catch{}}function a(){if(!n.name)return;const{gmMode:i,savedCharacters:s,...l}=n,c={...n.savedCharacters,[n.name]:l};e("savedCharacters",c);try{localStorage.setItem(pt,JSON.stringify(c))}catch{}}function r(i){const s=n.savedCharacters[i];s&&e({...s})}return{state:n,setState:e,setEnergy:t,loadFromStorage:o,saveCharacter:a,loadCharacter:r}}var pn=w('<div style=display:flex;align-items:center;gap:6px><label style=color:var(--sq-overlay-text-muted);font-size:12px;text-transform:uppercase;letter-spacing:1px>HP</label><select style="background:var(--sq-ctrl-bg);border:1px solid var(--sq-ctrl-border);color:var(--sq-ctrl-text);border-radius:4px;padding:4px 8px;font-size:13px;font-family:inherit;cursor:pointer">'),gn=w("<option>");function yn(n){const e=Array.from({length:31},(t,o)=>o);return(()=>{var t=pn(),o=t.firstChild,a=o.nextSibling;return a.addEventListener("change",r=>n.onHpChange(parseInt(r.currentTarget.value,10))),p(a,()=>e.map(r=>(()=>{var i=gn();return i.value=r,p(i,r),i})())),A(()=>a.value=n.hp),t})()}var mn=w("<div style=display:flex;gap:5px;align-items:center>"),bn=w('<div style="width:14px;height:14px;border-radius:50%;cursor:pointer;transition:background 0.15s, border-color 0.15s">');function wn(n){return(()=>{var e=mn();return p(e,m(U,{get each(){return n.energy},children:(t,o)=>(()=>{var a=bn();return a.$$click=()=>n.onEnergyClick(o()),_(a,"background",t?"var(--sq-overlay-text)":"var(--sq-dot-empty-bg)"),_(a,"border",`2px solid ${t?"var(--sq-overlay-text)":"var(--sq-dot-empty-border)"}`),a})()})),e})()}W(["click"]);var kn=w('<div style="background:var(--sq-row-1);border-bottom:1px solid var(--sq-row-border);position:sticky;top:0;z-index:100"><div style="padding:8px 14px 2px;font-size:13px;color:var(--sq-ctrl-text);text-transform:capitalize;user-select:none;-webkit-user-select:none;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"></div><div style="padding:4px 14px 10px;display:flex;align-items:center;gap:12px;flex-wrap:wrap">');function vn(n){const e=()=>[n.name,n.charClass,n.profession,n.personality].filter(Boolean).join(" · ");return(()=>{var t=kn(),o=t.firstChild,a=o.nextSibling;return p(o,e),p(a,m(yn,{get hp(){return n.hp},get onHpChange(){return n.onHpChange}}),null),p(a,m(wn,{get energy(){return n.energy},get onEnergyClick(){return n.onEnergyClick}}),null),t})()}var xn=w('<div style="background:var(--sq-row-2);border-bottom:1px solid var(--sq-row-border);padding:10px 14px;display:flex;gap:8px;flex-wrap:wrap"><input type=text placeholder="Character name"><select><option value>Personality</option></select><select><option value>Class</option></select><select><option value>Profession'),je=w("<option>");const Me={background:"var(--sq-ctrl-bg)",border:"1px solid var(--sq-ctrl-border)",color:"var(--sq-ctrl-text)","border-radius":"4px",padding:"5px 8px","font-size":"13px","font-family":"inherit",cursor:"pointer",flex:"1","min-width":"0","text-transform":"capitalize"},_n={background:"var(--sq-ctrl-bg)",border:"1px solid var(--sq-ctrl-border)",color:"var(--sq-ctrl-text)","border-radius":"4px",padding:"5px 8px","font-size":"13px","font-family":"inherit",flex:"1","min-width":"0",outline:"none"};function Cn(n){return(()=>{var e=xn(),t=e.firstChild,o=t.nextSibling;o.firstChild;var a=o.nextSibling;a.firstChild;var r=a.nextSibling;return r.firstChild,t.$$input=i=>n.onNameChange(i.currentTarget.value),we(t,_n),o.addEventListener("change",i=>n.onPersonalityChange(i.currentTarget.value)),p(o,m(U,{get each(){return n.personalities},children:i=>(()=>{var s=je();return s.value=i,p(s,i),s})()}),null),a.addEventListener("change",i=>n.onClassChange(i.currentTarget.value)),p(a,m(U,{get each(){return n.classes},children:i=>(()=>{var s=je();return s.value=i,p(s,i),s})()}),null),r.addEventListener("change",i=>n.onProfessionChange(i.currentTarget.value)),p(r,m(U,{get each(){return n.professions},children:i=>(()=>{var s=je();return s.value=i,p(s,i),s})()}),null),A(i=>{var s=Me,l=Me,c=Me;return i.e=we(o,s,i.e),i.t=we(a,l,i.t),i.a=we(r,c,i.a),i},{e:void 0,t:void 0,a:void 0}),A(()=>t.value=n.name),A(()=>o.value=n.personality),A(()=>a.value=n.charClass),A(()=>r.value=n.profession),e})()}W(["input"]);var Tn=w('<div style="background:var(--sq-row-2);border-bottom:1px solid var(--sq-row-border);padding:8px 14px"><div style=display:flex;gap:4px;flex-wrap:wrap></div><div style=color:var(--sq-overlay-text);font-size:11px;opacity:0.7;margin-top:4px;min-height:14px>'),Sn=w('<button style="border-radius:4px;padding:4px 12px;font-size:12px;font-family:inherit;cursor:pointer;transition:all 0.1s">');function An(n){const e=H(()=>n.statuses.find(t=>t.id===n.combat));return(()=>{var t=Tn(),o=t.firstChild,a=o.nextSibling;return p(o,m(U,{get each(){return n.statuses},children:r=>{const i=()=>n.combat===r.id;return(()=>{var s=Sn();return s.$$click=()=>n.onChange(r.id),p(s,()=>r.label),A(l=>{var c=i()?"var(--sq-accent)":"var(--sq-ctrl-bg)",u=i()?"#ffffff":"var(--sq-ctrl-text)",d=`1px solid ${i()?"var(--sq-accent)":"var(--sq-ctrl-border)"}`,f=i()?"600":"400";return c!==l.e&&_(s,"background",l.e=c),u!==l.t&&_(s,"color",l.t=u),d!==l.a&&_(s,"border",l.a=d),f!==l.o&&_(s,"font-weight",l.o=f),l},{e:void 0,t:void 0,a:void 0,o:void 0}),s})()}})),p(a,()=>{var r;return((r=e())==null?void 0:r.message)??""}),t})()}W(["click"]);function He(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let Z=He();function gt(n){Z=n}const yt=/[&<>"']/,Rn=new RegExp(yt.source,"g"),mt=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Dn=new RegExp(mt.source,"g"),$n={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},bt=n=>$n[n];function $(n,e){if(e){if(yt.test(n))return n.replace(Rn,bt)}else if(mt.test(n))return n.replace(Dn,bt);return n}const qn=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function En(n){return n.replace(qn,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const Yn=/(^|[^\[])\^/g;function y(n,e){let t=typeof n=="string"?n:n.source;e=e||"";const o={replace:(a,r)=>{let i=typeof r=="string"?r:r.source;return i=i.replace(Yn,"$1"),t=t.replace(a,i),o},getRegex:()=>new RegExp(t,e)};return o}function wt(n){try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const se={exec:()=>null};function kt(n,e){const t=n.replace(/\|/g,(r,i,s)=>{let l=!1,c=i;for(;--c>=0&&s[c]==="\\";)l=!l;return l?"|":" |"}),o=t.split(/ \|/);let a=0;if(o[0].trim()||o.shift(),o.length>0&&!o[o.length-1].trim()&&o.pop(),e)if(o.length>e)o.splice(e);else for(;o.length<e;)o.push("");for(;a<o.length;a++)o[a]=o[a].trim().replace(/\\\|/g,"|");return o}function Ce(n,e,t){const o=n.length;if(o===0)return"";let a=0;for(;a<o&&n.charAt(o-a-1)===e;)a++;return n.slice(0,o-a)}function zn(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let o=0;o<n.length;o++)if(n[o]==="\\")o++;else if(n[o]===e[0])t++;else if(n[o]===e[1]&&(t--,t<0))return o;return-1}function vt(n,e,t,o){const a=e.href,r=e.title?$(e.title):null,i=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){o.state.inLink=!0;const s={type:"link",raw:t,href:a,title:r,text:i,tokens:o.inlineTokens(i)};return o.state.inLink=!1,s}return{type:"image",raw:t,href:a,title:r,text:$(i)}}function On(n,e){const t=n.match(/^(\s+)(?:```)/);if(t===null)return e;const o=t[1];return e.split(`
`).map(a=>{const r=a.match(/^\s+/);if(r===null)return a;const[i]=r;return i.length>=o.length?a.slice(o.length):a}).join(`
`)}class Te{constructor(e){b(this,"options");b(this,"rules");b(this,"lexer");this.options=e||Z}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const o=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?o:Ce(o,`
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const o=t[0],a=On(o,t[3]||"");return{type:"code",raw:o,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:a}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let o=t[2].trim();if(/#$/.test(o)){const a=Ce(o,"#");(this.options.pedantic||!a||/ $/.test(a))&&(o=a.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:o,tokens:this.lexer.inline(o)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:t[0]}}blockquote(e){const t=this.rules.block.blockquote.exec(e);if(t){let o=t[0].replace(/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,`
    $1`);o=Ce(o.replace(/^ *>[ \t]?/gm,""),`
...
`,1)[0],h=0;this.options.pedantic?(h=2,l=d.trimStart()):(h=t[2].search(/[^ ]/),h=h>4?1:h,l=d.slice(h),h+=t[1].length);let k=!1;if(!d&&/^ *$/.test(f)&&(s+=f+`
`,e=e.substring(f.length+1),u=!0),!u){const B=new RegExp(`^ {0,${Math.min(3,h-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),q=new RegExp(`^ {0,${Math.min(3,h-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),E=new RegExp(`^ {0,${Math.min(3,h-1)}}(?:\`\`\`|~~~)`),z=new RegExp(`^ {0,${Math.min(3,h-1)}}#`);for(;e;){const N=e.split(`
`,1)[0];if(f=N,this.options.pedantic&&(f=f.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),E.test(f)||z.test(f)||B.test(f)||q.test(e))break;if(f.search(/[^ ]/)>=h||!f.trim())l+=`
`+f.slice(h);else{if(k||d.search(/[^ ]/)>=4||E.test(d)||z.test(d)||q.test(d))break;l+=`
`+f}!k&&!f.trim()&&(k=!0),s+=N+`
`,e=e.substring(N.length+1),d=f.slice(h)}}r.loose||(c?r.loose=!0:/\n *\n *$/.test(s)&&(c=!0));let v=null,D;this.options.gfm&&(v=/^\[[ xX]\] /.exec(l),v&&(D=v[0]!=="[ ] ",l=l.replace(/^\[[ xX]\] +/,""))),r.items.push({type:"list_item",raw:s,task:!!v,checked:D,loose:!1,text:l,tokens:[]}),r.raw+=s}r.items[r.items.length-1].raw=s.trimEnd(),r.items[r.items.length-1].text=l.trimEnd(),r.raw=r.raw.trimEnd();for(let u=0;u<r.items.length;u++)if(this.lexer.state.top=!1,r.items[u].tokens=this.lexer.blockTokens(r.items[u].text,[]),!r.loose){const d=r.items[u].tokens.filter(h=>h.type==="space"),f=d.length>0&&d.some(h=>/\n.*\n/.test(h.raw));r.loose=f}if(r.loose)for(let u=0;u<r.items.length;u++)r.items[u].loose=!0;return r}}html(e){const t=this.rules.block.html.exec(e);if(t)return{type:"html",block:!0,raw:t[0],pre:t[1]==="pre"||t[1]==="script"||t[1]==="style",text:t[0]}}def(e){const t=this.rules.block.def.exec(e);if(t){const o=t[1].toLowerCase().replace(/\s+/g," "),a=t[2]?t[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",r=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):t[3];return{type:"def",tag:o,raw:t[0],href:a,title:r}}}table(e){const t=this.rules.block.table.exec(e);if(!t||!/[:|]/.test(t[2]))return;const o=kt(t[1]),a=t[2].replace(/^\||\| *$/g,"").split("|"),r=t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,"").split(`
...
`?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:o,tokens:this.lexer.inline(o)}}}text(e){const t=this.rules.block.text.exec(e);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){const t=this.rules.inline.escape.exec(e);if(t)return{type:"escape",raw:t[0],text:$(t[1])}}tag(e){const t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&/^<a /i.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){const t=this.rules.inline.link.exec(e);if(t){const o=t[2].trim();if(!this.options.pedantic&&/^</.test(o)){if(!/>$/.test(o))return;const i=Ce(o.slice(0,-1),"\\");if((o.length-i.length)%2===0)return}else{const i=zn(t[2],"()");if(i>-1){const l=(t[0].indexOf("!")===0?5:4)+t[1].length+i;t[2]=t[2].substring(0,i),t[0]=t[0].substring(0,l).trim(),t[3]=""}}let a=t[2],r="";if(this.options.pedantic){const i=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(a);i&&(a=i[1],r=i[3])}else r=t[3]?t[3].slice(1,-1):"";return a=a.trim(),/^</.test(a)&&(this.options.pedantic&&!/>$/.test(o)?a=a.slice(1):a=a.slice(1,-1)),vt(t,{href:a&&a.replace(this.rules.inline.anyPunctuation,"$1"),title:r&&r.replace(this.rules.inline.anyPunctuation,"$1")},t[0],this.lexer)}}reflink(e,t){let o;if((o=this.rules.inline.reflink.exec(e))||(o=this.rules.inline.nolink.exec(e))){const a=(o[2]||o[1]).replace(/\s+/g," "),r=t[a.toLowerCase()];if(!r){const i=o[0].charAt(0);return{type:"text",raw:i,text:i}}return vt(o,r,o[0],this.lexer)}}emStrong(e,t,o=""){let a=this.rules.inline.emStrongLDelim.exec(e);if(!a||a[3]&&o.match(/[\p{L}\p{N}]/u))return;if(!(a[1]||a[2]||"")||!o||this.rules.inline.punctuation.exec(o)){const i=[...a[0]].length-1;let s,l,c=i,u=0;const d=a[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(d.lastIndex=0,t=t.slice(-1*e.length+i);(a=d.exec(t))!=null;){if(s=a[1]||a[2]||a[3]||a[4]||a[5]||a[6],!s)continue;if(l=[...s].length,a[3]||a[4]){c+=l;continue}else if((a[5]||a[6])&&i%3&&!((i+l)%3)){u+=l;continue}if(c-=l,c>0)continue;l=Math.min(l,l+c+u);const f=[...a[0]][0].length,h=e.slice(0,i+a.index+f+l);if(Math.min(i,l)%2){const v=h.slice(1,-1);return{type:"em",raw:h,text:v,tokens:this.lexer.inlineTokens(v)}}const k=h.slice(2,-2);return{type:"strong",raw:h,text:k,tokens:this.lexer.inlineTokens(k)}}}}codespan(e){const t=this.rules.inline.code.exec(e);if(t){let o=t[2].replace(/\n/g," ");const a=/[^ ]/.test(o),r=/^ /.test(o)&&/ $/.test(o);return a&&r&&(o=o.substring(1,o.length-1)),o=$(o,!0),{type:"codespan",raw:t[0],text:o}}}br(e){const t=this.rules.inline.br.exec(e);if(t)return{type:"br",raw:t[0]}}del(e){const t=this.rules.inline.del.exec(e);if(t)return{type:"del",raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e){const t=this.rules.inline.autolink.exec(e);if(t){let o,a;return t[2]==="@"?(o=$(t[1]),a="mailto:"+o):(o=$(t[1]),a=o),{type:"link",raw:t[0],text:o,href:a,tokens:[{type:"text",raw:o,text:o}]}}}url(e){var o;let t;if(t=this.rules.inline.url.exec(e)){let a,r;if(t[2]==="@")a=$(t[0]),r="mailto:"+a;else{let i;do i=t[0],t[0]=((o=this.rules.inline._backpedal.exec(t[0]))==null?void 0:o[0])??"";while(i!==t[0]);a=$(t[0]),t[1]==="www."?r="http://"+t[0]:r=t[0]}return{type:"link",raw:t[0],text:a,href:r,tokens:[{type:"text",raw:a,text:a}]}}}inlineText(e){const t=this.rules.inline.text.exec(e);if(t){let o;return this.lexer.state.inRawBlock?o=t[0]:o=$(t[0]),{type:"text",raw:t[0],text:o}}}}const In=/^(?: *(?:\n|$))+/,Pn=/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,Nn=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,le=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Ln=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,xt=/(?:[*+-]|\d{1,9}[.)])/,_t=y(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,xt).replace(/blockCode/g,/ {4}/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),Be=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,jn=/^[^\n]+/,Fe=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Mn=y(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace("label",Fe).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Hn=y(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,xt).getRegex(),Se="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Ge=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Bn=y("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))","i").replace("comment",Ge).replace("tag",Se).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ct=y(Be).replace("hr",le).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Se).getRegex(),Ue={blockquote:y(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Ct).getRegex(),code:Pn,def:Mn,fences:Nn,heading:Ln,hr:le,html:Bn,lheading:_t,list:Hn,newline:In,paragraph:Ct,table:se,text:jn},Tt=y("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",le).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Se).getRegex(),Fn={...Ue,table:Tt,paragraph:y(Be).replace("hr",le).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Tt).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Se).getRegex()},Gn={...Ue,html:y(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Ge).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:se,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:y(Be).replace("hr",le).replace("heading",` *#{1,6} *[^
]`).replace("lheading",_t).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},St=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Un=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,At=/^( {2,}|\\)\n(?!\s*$)/,Wn=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,ce="\\p{P}\\p{S}",Zn=y(/^((?![*_])[\spunctuation])/,"u").replace(/punctuation/g,ce).getRegex(),Kn=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,Qn=y(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,"u").replace(/punct/g,ce).getRegex(),Vn=y("^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])","gu").replace(/punct/g,ce).getRegex(),Xn=y("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])","gu").replace(/punct/g,ce).getRegex(),Jn=y(/\\([punct])/,"gu").replace(/punct/g,ce).getRegex(),eo=y(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),to=y(Ge).replace("(?:-->|$)","-->").getRegex(),no=y("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",to).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Ae=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,oo=y(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",Ae).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),Rt=y(/^!?\[(label)\]\[(ref)\]/).replace("label",Ae).replace("ref",Fe).getRegex(),Dt=y(/^!?\[(ref)\](?:\[\])?/).replace("ref",Fe).getRegex(),ao=y("reflink|nolink(?!\\()","g").replace("reflink",Rt).replace("nolink",Dt).getRegex(),We={_backpedal:se,anyPunctuation:Jn,autolink:eo,blockSkip:Kn,br:At,code:Un,del:se,emStrongLDelim:Qn,emStrongRDelimAst:Vn,emStrongRDelimUnd:Xn,escape:St,link:oo,nolink:Dt,punctuation:Zn,reflink:Rt,reflinkSearch:ao,tag:no,text:Wn,url:se},ro={...We,link:y(/^!?\[(label)\]\((.*?)\)/).replace("label",Ae).getRegex(),reflink:y(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Ae).getRegex()},Ze={...We,escape:y(St).replace("])","~|])").getRegex(),url:y(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},io={...Ze,br:y(At).replace("{2,}","*").getRegex(),text:y(Ze.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Re={normal:Ue,gfm:Fn,pedantic:Gn},ue={normal:We,gfm:Ze,breaks:io,pedantic:ro};class I{constructor(e){b(this,"tokens");b(this,"options");b(this,"state");b(this,"tokenizer");b(this,"inlineQueue");this.tokens=[],this.tokens.links=Object.create(null),this.options=e||Z,this.options.tokenizer=this.options.tokenizer||new Te,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};const t={block:Re.normal,inline:ue.normal};this.options.pedantic?(t.block=Re.pedantic,t.inline=ue.pedantic):this.options.gfm&&(t.block=Re.gfm,this.options.breaks?t.inline=ue.breaks:t.inline=ue.gfm),this.tokenizer.rules=t}static get rules(){return{block:Re,inline:ue}}static lex(e,t){return new I(t).lex(e)}static lexInline(e,t){return new I(t).inlineTokens(e)}lex(e){e=e.replace(/\r\n|\r/g,`
...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return"<br>"}del(e){return`<del>${e}</del>`}link(e,t,o){const a=wt(e);if(a===null)return o;e=a;let r='<a href="'+e+'"';return t&&(r+=' title="'+t+'"'),r+=">"+o+"</a>",r}image(e,t,o){const a=wt(e);if(a===null)return o;e=a;let r=`<img src="${e}" alt="${o}"`;return t&&(r+=` title="${t}"`),r+=">",r}text(e){return e}}class Ke{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,o){return""+o}image(e,t,o){return""+o}br(){return""}}class P{constructor(e){b(this,"options");b(this,"renderer");b(this,"textRenderer");this.options=e||Z,this.options.renderer=this.options.renderer||new De,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Ke}static parse(e,t){return new P(t).parse(e)}static parseInline(e,t){return new P(t).parseInline(e)}parse(e,t=!0){let o="";for(let a=0;a<e.length;a++){const r=e[a];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]){const i=r,s=this.options.extensions.renderers[i.type].call({parser:this},i);if(s!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(i.type)){o+=s||"";continue}}switch(r.type){case"space":continue;case"hr":{o+=this.renderer.hr();continue}case"heading":{const i=r;o+=this.renderer.heading(this.parseInline(i.tokens),i.depth,En(this.parseInline(i.tokens,this.textRenderer)));continue}case"code":{const i=r;o+=this.renderer.code(i.text,i.lang,!!i.escaped);continue}case"table":{const i=r;let s="",l="";for(let u=0;u<i.header.length;u++)l+=this.renderer.tablecell(this.parseInline(i.header[u].tokens),{header:!0,align:i.align[u]});s+=this.renderer.tablerow(l);let c="";for(let u=0;u<i.rows.length;u++){const d=i.rows[u];l="";for(let f=0;f<d.length;f++)l+=this.renderer.tablecell(this.parseInline(d[f].tokens),{header:!1,align:i.align[f]});c+=this.renderer.tablerow(l)}o+=this.renderer.table(s,c);continue}case"blockquote":{const i=r,s=this.parse(i.tokens);o+=this.renderer.blockquote(s);continue}case"list":{const i=r,s=i.ordered,l=i.start,c=i.loose;let u="";for(let d=0;d<i.items.length;d++){const f=i.items[d],h=f.checked,k=f.task;let v="";if(f.task){const D=this.renderer.checkbox(!!h);c?f.tokens.length>0&&f.tokens[0].type==="paragraph"?(f.tokens[0].text=D+" "+f.tokens[0].text,f.tokens[0].tokens&&f.tokens[0].tokens.length>0&&f.tokens[0].tokens[0].type==="text"&&(f.tokens[0].tokens[0].text=D+" "+f.tokens[0].tokens[0].text)):f.tokens.unshift({type:"text",text:D+" "}):v+=D+" "}v+=this.parse(f.tokens,c),u+=this.renderer.listitem(v,k,!!h)}o+=this.renderer.list(u,s,l);continue}case"html":{const i=r;o+=this.renderer.html(i.text,i.block);continue}case"paragraph":{const i=r;o+=this.renderer.paragraph(this.parseInline(i.tokens));continue}case"text":{let i=r,s=i.tokens?this.parseInline(i.tokens):i.text;for(;a+1<e.length&&e[a+1].type==="text";)i=e[++a],s+=`
`+(i.tokens?this.parseInline(i.tokens):i.text);o+=t?this.renderer.paragraph(s):s;continue}default:{const i='Token with "'+r.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return o}parseInline(e,t){t=t||this.renderer;let o="";for(let a=0;a<e.length;a++){const r=e[a];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]){const i=this.options.extensions.renderers[r.type].call({parser:this},r);if(i!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(r.type)){o+=i||"";continue}}switch(r.type){case"escape":{const i=r;o+=t.text(i.text);break}case"html":{const i=r;o+=t.html(i.text);break}case"link":{const i=r;o+=t.link(i.href,i.title,this.parseInline(i.tokens,t));break}case"image":{const i=r;o+=t.image(i.href,i.title,i.text);break}case"strong":{const i=r;o+=t.strong(this.parseInline(i.tokens,t));break}case"em":{const i=r;o+=t.em(this.parseInline(i.tokens,t));break}case"codespan":{const i=r;o+=t.codespan(i.text);break}case"br":{o+=t.br();break}case"del":{const i=r;o+=t.del(this.parseInline(i.tokens,t));break}case"text":{const i=r;o+=t.text(i.text);break}default:{const i='Token with "'+r.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return o}}class de{constructor(e){b(this,"options");this.options=e||Z}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}}b(de,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));class so{constructor(...e){qt(this,Q);b(this,"defaults",He());b(this,"options",this.setOptions);b(this,"parse",qe(this,Q,Qe).call(this,I.lex,P.parse));b(this,"parseInline",qe(this,Q,Qe).call(this,I.lexInline,P.parseInline));b(this,"Parser",P);b(this,"Renderer",De);b(this,"TextRenderer",Ke);b(this,"Lexer",I);b(this,"Tokenizer",Te);b(this,"Hooks",de);this.use(...e)}walkTokens(e,t){var a,r;let o=[];for(const i of e)switch(o=o.concat(t.call(this,i)),i.type){case"table":{const s=i;for(const l of s.header)o=o.concat(this.walkTokens(l.tokens,t));for(const l of s.rows)for(const c of l)o=o.concat(this.walkTokens(c.tokens,t));break}case"list":{const s=i;o=o.concat(this.walkTokens(s.items,t));break}default:{const s=i;(r=(a=this.defaults.extensions)==null?void 0:a.childTokens)!=null&&r[s.type]?this.defaults.extensions.childTokens[s.type].forEach(l=>{const c=s[l].flat(1/0);o=o.concat(this.walkTokens(c,t))}):s.tokens&&(o=o.concat(this.walkTokens(s.tokens,t)))}}return o}use(...e){const t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(o=>{const a={...o};if(a.async=this.defaults.async||a.async||!1,o.extensions&&(o.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){const i=t.renderers[r.name];i?t.renderers[r.name]=function(...s){let l=r.renderer.apply(this,s);return l===!1&&(l=i.apply(this,s)),l}:t.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const i=t[r.level];i?i.unshift(r.tokenizer):t[r.level]=[r.tokenizer],r.start&&(r.level==="block"?t.startBlock?t.startBlock.push(r.start):t.startBlock=[r.start]:r.level==="inline"&&(t.startInline?t.startInline.push(r.start):t.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(t.childTokens[r.name]=r.childTokens)}),a.extensions=t),o.renderer){const r=this.defaults.renderer||new De(this.defaults);for(const i in o.renderer){if(!(i in r))throw new Error(`renderer '${i}' does not exist`);if(i==="options")continue;const s=i,l=o.renderer[s],c=r[s];r[s]=(...u)=>{let d=l.apply(r,u);return d===!1&&(d=c.apply(r,u)),d||""}}a.renderer=r}if(o.tokenizer){const r=this.defaults.tokenizer||new Te(this.defaults);for(const i in o.tokenizer){if(!(i in r))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;const s=i,l=o.tokenizer[s],c=r[s];r[s]=(...u)=>{let d=l.apply(r,u);return d===!1&&(d=c.apply(r,u)),d}}a.tokenizer=r}if(o.hooks){const r=this.defaults.hooks||new de;for(const i in o.hooks){if(!(i in r))throw new Error(`hook '${i}' does not exist`);if(i==="options")continue;const s=i,l=o.hooks[s],c=r[s];de.passThroughHooks.has(i)?r[s]=u=>{if(this.defaults.async)return Promise.resolve(l.call(r,u)).then(f=>c.call(r,f));const d=l.call(r,u);return c.call(r,d)}:r[s]=(...u)=>{let d=l.apply(r,u);return d===!1&&(d=c.apply(r,u)),d}}a.hooks=r}if(o.walkTokens){const r=this.defaults.walkTokens,i=o.walkTokens;a.walkTokens=function(s){let l=[];return l.push(i.call(this,s)),r&&(l=l.concat(r.call(this,s))),l}}this.defaults={...this.defaults,...a}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return I.lex(e,t??this.defaults)}parser(e,t){return P.parse(e,t??this.defaults)}}Q=new WeakSet,Qe=function(e,t){return(o,a)=>{const r={...a},i={...this.defaults,...r};this.defaults.async===!0&&r.async===!1&&(i.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),i.async=!0);const s=qe(this,Q,Et).call(this,!!i.silent,!!i.async);if(typeof o>"u"||o===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof o!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(o)+", string expected"));if(i.hooks&&(i.hooks.options=i),i.async)return Promise.resolve(i.hooks?i.hooks.preprocess(o):o).then(l=>e(l,i)).then(l=>i.hooks?i.hooks.processAllTokens(l):l).then(l=>i.walkTokens?Promise.all(this.walkTokens(l,i.walkTokens)).then(()=>l):l).then(l=>t(l,i)).then(l=>i.hooks?i.hooks.postprocess(l):l).catch(s);try{i.hooks&&(o=i.hooks.preprocess(o));let l=e(o,i);i.hooks&&(l=i.hooks.processAllTokens(l)),i.walkTokens&&this.walkTokens(l,i.walkTokens);let c=t(l,i);return i.hooks&&(c=i.hooks.postprocess(c)),c}catch(l){return s(l)}}},Et=function(e,t){return o=>{if(o.message+=`
Please report this to https://github.com/markedjs/marked.`,e){const a="<p>An error occurred:</p><pre>"+$(o.message+"",!0)+"</pre>";return t?Promise.resolve(a):a}if(t)return Promise.reject(o);throw o}};const K=new so;function g(n,e){return K.parse(n,e)}g.options=g.setOptions=function(n){return K.setOptions(n),g.defaults=K.defaults,gt(g.defaults),g},g.getDefaults=He,g.defaults=Z,g.use=function(...n){return K.use(...n),g.defaults=K.defaults,gt(g.defaults),g},g.walkTokens=function(n,e){return K.walkTokens(n,e)},g.parseInline=K.parseInline,g.Parser=P,g.parser=P.parse,g.Renderer=De,g.TextRenderer=Ke,g.Lexer=I,g.lexer=I.lex,g.Tokenizer=Te,g.Hooks=de,g.parse=g,g.options,g.setOptions,g.use,g.walkTokens,g.parseInline,P.parse,I.lex;var lo=w('<div style="background:#ffffff;border-radius:6px;margin-bottom:8px;overflow:hidden;transition:opacity 0.2s, box-shadow 0.15s"><div style="display:flex;align-items:center;padding:10px 12px"><span style=flex:1;font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px;user-select:none></span><div style=display:flex;gap:6px;align-items:center;margin-right:8px>'),co=w('<span style="background:#ddd;color:#999;border-radius:3px;padding:2px 6px;font-size:9px;font-weight:700;letter-spacing:0.5px">USED'),uo=w('<span style="border-radius:3px;padding:2px 8px;font-size:10px;font-weight:700;white-space:nowrap;transition:all 0.15s"> energy'),ho=w('<span style="color:#aaaaaa;font-size:12px;cursor:pointer;user-select:none;padding:0 2px">'),fo=w(`<div style="padding:0 12px 10px;color:#555555;font-size:13px;line-height:1.6;font-family:'Varela Round', 'Nunito', sans-serif">`);function po(n){return g.parse(n).replace(/\bD(\d+)\b/g,"<strong>D$1</strong>")}function go(n){const[e,t]=V(!1);function o(){var r;n.used||(r=n.onActivate)==null||r.call(n,n.card)}function a(r){r.stopPropagation(),!n.used&&t(i=>!i)}return(()=>{var r=lo(),i=r.firstChild,s=i.firstChild,l=s.nextSibling;return s.$$click=o,p(s,()=>n.card.title),p(l,(()=>{var c=O(()=>!!n.used);return()=>c()?co():O(()=>n.card.energyCost!==void 0)()&&(()=>{var u=uo(),d=u.firstChild;return p(u,()=>n.card.energyCost,d),A(f=>{var h=n.selected?"var(--sq-accent)":"rgba(0,0,0,0.12)",k=n.selected?"#fff":"var(--sq-accent)";return h!==f.e&&_(u,"background",f.e=h),k!==f.t&&_(u,"color",f.t=k),f},{e:void 0,t:void 0}),u})()})()),p(i,(()=>{var c=O(()=>!n.used);return()=>c()&&(()=>{var u=ho();return u.$$click=a,p(u,()=>e()?"▲":"▼"),u})()})(),null),p(r,(()=>{var c=O(()=>!!(e()&&!n.used));return()=>c()&&(()=>{var u=fo();return A(()=>u.innerHTML=po(n.card.body)),u})()})(),null),A(c=>{var u=n.selected?"0 0 0 2px var(--sq-accent), 0px -2px 4px rgba(0,0,0,0.15)":"0px -2px 4px rgba(0,0,0,0.2)",d=`2px solid ${n.used?"#e0e0e0":n.selected?"var(--sq-accent)":"transparent"}`,f=n.used?.45:1,h=n.selected?"color-mix(in srgb, var(--sq-accent) 8%, white)":"transparent",k=n.used?"#bbbbbb":"var(--sq-accent)",v=n.used?"line-through":"none",D=n.used?"default":"pointer";return u!==c.e&&_(r,"box-shadow",c.e=u),d!==c.t&&_(r,"border",c.t=d),f!==c.a&&_(r,"opacity",c.a=f),h!==c.o&&_(i,"background",c.o=h),k!==c.i&&_(s,"color",c.i=k),v!==c.n&&_(s,"text-decoration",c.n=v),D!==c.s&&_(s,"cursor",c.s=D),c},{e:void 0,t:void 0,a:void 0,o:void 0,i:void 0,n:void 0,s:void 0}),r})()}W(["click"]);var yo=w('<div style="background:#ffffff;border-radius:6px;margin-bottom:8px;box-shadow:0px -2px 4px rgba(0,0,0,0.2);overflow:hidden"><div style="display:flex;justify-content:space-between;align-items:center;padding:10px 12px;cursor:pointer;user-select:none"><span style=color:var(--sq-accent);font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px></span><span style=color:#aaaaaa;font-size:12px>'),mo=w(`<div style="padding:0 12px 10px;color:#555555;font-size:13px;line-height:1.6;font-family:'Varela Round', 'Nunito', sans-serif">`);function $e(n){const[e,t]=V(!1);return(()=>{var o=yo(),a=o.firstChild,r=a.firstChild,i=r.nextSibling;return a.$$click=()=>t(s=>!s),p(r,()=>n.title),p(i,()=>e()?"▲":"▼"),p(o,(()=>{var s=O(()=>!!e());return()=>s()&&(()=>{var l=mo();return A(()=>l.innerHTML=g.parse(n.body)),l})()})(),null),o})()}W(["click"]);var bo=w('<div style="padding:12px 14px">');function wo(n){const e=H(()=>n.abilities.filter(t=>{const o=t.source===n.charClass||t.source===n.profession||t.source==="general",a=t.context===n.combat;return o&&a}));return(()=>{var t=bo();return p(t,m(oe,{get when(){return O(()=>n.combat==="isDead")()&&n.deathContent},get children(){return m($e,{title:"Dead",get body(){return n.deathContent}})}}),null),p(t,m(oe,{get when(){return O(()=>n.combat==="inGeneral")()&&!!n.descriptions[n.personality]},get children(){return m($e,{get title(){return n.personality},get body(){return n.descriptions[n.personality]}})}}),null),p(t,m(oe,{get when(){return O(()=>n.combat==="inGeneral")()&&!!n.descriptions[n.charClass]},get children(){return m($e,{get title(){return n.charClass},get body(){return n.descriptions[n.charClass]}})}}),null),p(t,m(oe,{get when(){return O(()=>n.combat==="inGeneral")()&&!!n.descriptions[n.profession]},get children(){return m($e,{get title(){return n.profession},get body(){return n.descriptions[n.profession]}})}}),null),p(t,m(U,{get each(){return e()},children:o=>m(go,{card:o,get used(){return n.usedAbilities.includes(o.title)},get selected(){return n.selectedAbility===o.title},get onActivate(){return n.onActivate}})}),null),t})()}var ko=w('<div style="background:var(--sq-row-3);border-top:1px solid var(--sq-row-border);padding:8px 14px;display:flex;gap:10px;align-items:center;flex-wrap:wrap"><span style=color:var(--sq-overlay-text-muted);font-size:12px;text-transform:uppercase;letter-spacing:1px>GM</span><div style="width:36px;height:18px;border-radius:9px;cursor:pointer;position:relative;transition:background 0.2s;flex-shrink:0"><div style="width:14px;height:14px;background:#ffffff;border-radius:50%;position:absolute;top:1px;transition:left 0.2s"></div></div><button style="margin-left:auto;background:var(--sq-ctrl-bg);border:1px solid var(--sq-ctrl-border);color:var(--sq-overlay-text);border-radius:50%;width:24px;height:24px;font-size:13px;font-weight:700;font-family:inherit;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0">?'),vo=w('<button style="background:var(--sq-ctrl-bg);border:1px solid var(--sq-accent);color:var(--sq-accent);border-radius:4px;padding:3px 10px;font-size:12px;font-family:inherit">Save'),xo=w('<select style="background:var(--sq-ctrl-bg);border:1px solid var(--sq-ctrl-border);color:var(--sq-ctrl-text);border-radius:4px;padding:3px 8px;font-size:12px;font-family:inherit;cursor:pointer"><option value>Load character...'),_o=w("<option>");function Co(n){const e=()=>Object.keys(n.savedCharacters);return(()=>{var t=ko(),o=t.firstChild,a=o.nextSibling,r=a.firstChild,i=a.nextSibling;return a.$$click=()=>n.onToggle(!n.enabled),p(t,(()=>{var s=O(()=>!!n.enabled);return()=>s()&&[(()=>{var l=vo();return Ie(l,"click",n.onSave),A(c=>{var u=!n.characterName,d=n.characterName?"pointer":"not-allowed",f=n.characterName?"1":"0.4";return u!==c.e&&(l.disabled=c.e=u),d!==c.t&&_(l,"cursor",c.t=d),f!==c.a&&_(l,"opacity",c.a=f),c},{e:void 0,t:void 0,a:void 0}),l})(),(()=>{var l=xo();return l.firstChild,l.addEventListener("change",c=>{c.currentTarget.value&&n.onLoad(c.currentTarget.value),c.currentTarget.value=""}),p(l,m(U,{get each(){return e()},children:c=>(()=>{var u=_o();return u.value=c,p(u,c),u})()}),null),l})()]})(),i),Ie(i,"click",n.onHelpOpen),A(s=>{var l=n.enabled?"var(--sq-accent)":"var(--sq-ctrl-bg)",c=`1px solid ${n.enabled?"var(--sq-accent)":"var(--sq-ctrl-border)"}`,u=n.enabled?"19px":"1px";return l!==s.e&&_(a,"background",s.e=l),c!==s.t&&_(a,"border",s.t=c),u!==s.a&&_(r,"left",s.a=u),s},{e:void 0,t:void 0,a:void 0}),t})()}W(["click"]);var To=w(`<div style=position:absolute;inset:0;background:#ffffff;z-index:500;overflow:auto;padding:16px><div style=display:flex;justify-content:space-between;align-items:center;margin-bottom:12px><span style=color:var(--sq-accent);font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px>General Rules</span><button style=background:var(--sq-accent);color:#ffffff;border:none;border-radius:50%;width:28px;height:28px;font-size:16px;font-weight:700;font-family:inherit;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0>×</button></div><div style="color:#3f3e4a;font-size:13px;line-height:1.7;font-family:'Varela Round', 'Nunito', sans-serif">`);function So(n){return(()=>{var e=To(),t=e.firstChild,o=t.firstChild,a=o.nextSibling,r=t.nextSibling;return Ie(a,"click",n.onClose),A(()=>r.innerHTML=g.parse(n.body)),e})()}W(["click"]);const Ao='@import"https://fonts.googleapis.com/css2?family=Varela+Round&family=Nunito:wght@400;600;700&display=swap";/*! tailwindcss v4.2.4 | MIT License | https://tailwindcss.com */@layer properties{@supports (((-webkit-hyphens:none)) and (not (margin-trim:inline))) or ((-moz-orient:inline) and (not (color:rgb(from red r g b)))){*,:before,:after,::backdrop{--tw-rotate-x:initial;--tw-rotate-y:initial;--tw-rotate-z:initial;--tw-skew-x:initial;--tw-skew-y:initial;--tw-border-style:solid;--tw-ordinal:initial;--tw-slashed-zero:initial;--tw-numeric-figure:initial;--tw-numeric-spacing:initial;--tw-numeric-fraction:initial;--tw-shadow:0 0 #0000;--tw-shadow-color:initial;--tw-shadow-alpha:100%;--tw-inset-shadow:0 0 #0000;--tw-inset-shadow-color:initial;--tw-inset-shadow-alpha:100%;--tw-ring-color:initial;--tw-ring-shadow:0 0 #0000;--tw-inset-ring-color:initial;--tw-inset-ring-shadow:0 0 #0000;--tw-ring-inset:initial;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-offset-shadow:0 0 #0000;--tw-outline-style:solid;--tw-blur:initial;--tw-brightness:initial;--tw-contrast:initial;--tw-grayscale:initial;--tw-hue-rotate:initial;--tw-invert:initial;--tw-opacity:initial;--tw-saturate:initial;--tw-sepia:initial;--tw-drop-shadow:initial;--tw-drop-shadow-color:initial;--tw-drop-shadow-alpha:100%;--tw-drop-shadow-size:initial;--tw-backdrop-blur:initial;--tw-backdrop-brightness:initial;--tw-backdrop-contrast:initial;--tw-backdrop-grayscale:initial;--tw-backdrop-hue-rotate:initial;--tw-backdrop-invert:initial;--tw-backdrop-opacity:initial;--tw-backdrop-saturate:initial;--tw-backdrop-sepia:initial}}}@layer theme{:root,:host{--font-sans:ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";--font-mono:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;--color-red-900:oklch(39.6% .141 25.723);--spacing:.25rem;--default-transition-duration:.15s;--default-transition-timing-function:cubic-bezier(.4, 0, .2, 1);--default-font-family:var(--font-sans);--default-mono-font-family:var(--font-mono)}}@layer base{*,:after,:before,::backdrop{box-sizing:border-box;border:0 solid;margin:0;padding:0}::file-selector-button{box-sizing:border-box;border:0 solid;margin:0;padding:0}html,:host{-webkit-text-size-adjust:100%;-moz-tab-size:4;tab-size:4;line-height:1.5;font-family:var(--default-font-family,ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji");font-feature-settings:var(--default-font-feature-settings,normal);font-variation-settings:var(--default-font-variation-settings,normal);-webkit-tap-highlight-color:transparent}hr{height:0;color:inherit;border-top-width:1px}abbr:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;-webkit-text-decoration:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,samp,pre{font-family:var(--default-mono-font-family,ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace);font-feature-settings:var(--default-mono-font-feature-settings,normal);font-variation-settings:var(--default-mono-font-variation-settings,normal);font-size:1em}small{font-size:80%}sub,sup{vertical-align:baseline;font-size:75%;line-height:0;position:relative}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit;border-collapse:collapse}:-moz-focusring{outline:auto}progress{vertical-align:baseline}summary{display:list-item}ol,ul,menu{list-style:none}img,svg,video,canvas,audio,iframe,embed,object{vertical-align:middle;display:block}img,video{max-width:100%;height:auto}button,input,select,optgroup,textarea{font:inherit;font-feature-settings:inherit;font-variation-settings:inherit;letter-spacing:inherit;color:inherit;opacity:1;background-color:#0000;border-radius:0}::file-selector-button{font:inherit;font-feature-settings:inherit;font-variation-settings:inherit;letter-spacing:inherit;color:inherit;opacity:1;background-color:#0000;border-radius:0}:where(select:is([multiple],[size])) optgroup{font-weight:bolder}:where(select:is([multiple],[size])) optgroup option{padding-inline-start:20px}::file-selector-button{margin-inline-end:4px}::placeholder{opacity:1}@supports (not ((-webkit-appearance:-apple-pay-button))) or (contain-intrinsic-size:1px){::placeholder{color:currentColor}@supports (color:color-mix(in lab,red,red)){::placeholder{color:color-mix(in oklab,currentcolor 50%,transparent)}}}textarea{resize:vertical}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-date-and-time-value{min-height:1lh;text-align:inherit}::-webkit-datetime-edit{display:inline-flex}::-webkit-datetime-edit-fields-wrapper{padding:0}::-webkit-datetime-edit{padding-block:0}::-webkit-datetime-edit-year-field{padding-block:0}::-webkit-datetime-edit-month-field{padding-block:0}::-webkit-datetime-edit-day-field{padding-block:0}::-webkit-datetime-edit-hour-field{padding-block:0}::-webkit-datetime-edit-minute-field{padding-block:0}::-webkit-datetime-edit-second-field{padding-block:0}::-webkit-datetime-edit-millisecond-field{padding-block:0}::-webkit-datetime-edit-meridiem-field{padding-block:0}::-webkit-calendar-picker-indicator{line-height:1}:-moz-ui-invalid{box-shadow:none}button,input:where([type=button],[type=reset],[type=submit]){-webkit-appearance:button;-moz-appearance:button;appearance:button}::file-selector-button{-webkit-appearance:button;-moz-appearance:button;appearance:button}::-webkit-inner-spin-button{height:auto}::-webkit-outer-spin-button{height:auto}[hidden]:where(:not([hidden=until-found])){display:none!important}}@layer components;@layer utilities{.invisible{visibility:hidden}.visible{visibility:visible}.absolute{position:absolute}.fixed{position:fixed}.relative{position:relative}.static{position:static}.sticky{position:sticky}.start{inset-inline-start:var(--spacing)}.end{inset-inline-end:var(--spacing)}.isolate{isolation:isolate}.order-0,.order-none{order:0}.container{width:100%}@media(min-width:40rem){.container{max-width:40rem}}@media(min-width:48rem){.container{max-width:48rem}}@media(min-width:64rem){.container{max-width:64rem}}@media(min-width:80rem){.container{max-width:80rem}}@media(min-width:96rem){.container{max-width:96rem}}.\\!hidden{display:none!important}.block{display:block}.contents{display:contents}.flex{display:flex}.grid{display:grid}.hidden{display:none}.inline{display:inline}.inline-block{display:inline-block}.table{display:table}.table-caption{display:table-caption}.table-cell{display:table-cell}.flex-shrink{flex-shrink:1}.flex-grow,.grow{flex-grow:1}.border-collapse{border-collapse:collapse}.transform{transform:var(--tw-rotate-x,) var(--tw-rotate-y,) var(--tw-rotate-z,) var(--tw-skew-x,) var(--tw-skew-y,)}.resize{resize:both}.flex-wrap{flex-wrap:wrap}.truncate{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.rounded{border-radius:.25rem}.border{border-style:var(--tw-border-style);border-width:1px}.mask-repeat{-webkit-mask-repeat:repeat;mask-repeat:repeat}.text-wrap{text-wrap:wrap}.break-words,.wrap-break-word{overflow-wrap:break-word}.capitalize{text-transform:capitalize}.lowercase{text-transform:lowercase}.uppercase{text-transform:uppercase}.italic{font-style:italic}.ordinal{--tw-ordinal:ordinal;font-variant-numeric:var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)}.line-through{text-decoration-line:line-through}.underline{text-decoration-line:underline}.shadow{--tw-shadow:0 1px 3px 0 var(--tw-shadow-color,#0000001a), 0 1px 2px -1px var(--tw-shadow-color,#0000001a);box-shadow:var(--tw-inset-shadow),var(--tw-inset-ring-shadow),var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow)}.outline{outline-style:var(--tw-outline-style);outline-width:1px}.blur{--tw-blur:blur(8px);filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.grayscale{--tw-grayscale:grayscale(100%);filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.invert{--tw-invert:invert(100%);filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.sepia{--tw-sepia:sepia(100%);filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.\\!filter{filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)!important}.filter{filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.backdrop-filter{-webkit-backdrop-filter:var(--tw-backdrop-blur,) var(--tw-backdrop-brightness,) var(--tw-backdrop-contrast,) var(--tw-backdrop-grayscale,) var(--tw-backdrop-hue-rotate,) var(--tw-backdrop-invert,) var(--tw-backdrop-opacity,) var(--tw-backdrop-saturate,) var(--tw-backdrop-sepia,);backdrop-filter:var(--tw-backdrop-blur,) var(--tw-backdrop-brightness,) var(--tw-backdrop-contrast,) var(--tw-backdrop-grayscale,) var(--tw-backdrop-hue-rotate,) var(--tw-backdrop-invert,) var(--tw-backdrop-opacity,) var(--tw-backdrop-saturate,) var(--tw-backdrop-sepia,)}.transition{transition-property:color,background-color,border-color,outline-color,text-decoration-color,fill,stroke,--tw-gradient-from,--tw-gradient-via,--tw-gradient-to,opacity,box-shadow,transform,translate,scale,rotate,filter,-webkit-backdrop-filter,backdrop-filter,display,content-visibility,overlay,pointer-events;transition-timing-function:var(--tw-ease,var(--default-transition-timing-function));transition-duration:var(--tw-duration,var(--default-transition-duration))}.data-\\[personality\\=passionate\\]\\:bg-red-900[data-personality=passionate]{background-color:var(--color-red-900)}}:host{font-family:var(--sq-font-family,"Varela Round", "Nunito", sans-serif);--sq-bg:#888;--sq-accent:#888;--sq-overlay-text:#fffffff2;--sq-overlay-text-muted:#ffffff8c;--sq-ctrl-bg:#ffffff26;--sq-ctrl-border:#ffffff4d;--sq-ctrl-text:#fffffff2;--sq-row-1:#00000026;--sq-row-2:#0000001a;--sq-row-3:#0003;--sq-row-border:#0000001f;--sq-dot-empty-bg:#fff3;--sq-dot-empty-border:#fff6;background-color:var(--sq-bg);color:#3f3e4a;display:block}:host([data-personality=passionate]){--sq-bg:#943a11;--sq-accent:#943a11}:host([data-personality=calculating]){--sq-bg:#26869d;--sq-accent:#26869d}:host([data-personality=wild]){--sq-bg:#758d2c;--sq-accent:#758d2c}:host([data-personality=selfish]){--sq-bg:#3f3e4a;--sq-accent:#3f3e4a}:host([data-personality=righteous]){--sq-bg:#daceae;--sq-accent:#5a5060;--sq-overlay-text:#5a5060;--sq-overlay-text-muted:#5a506080;--sq-ctrl-bg:#0000000f;--sq-ctrl-border:#5a506040;--sq-ctrl-text:#5a5060;--sq-row-1:#0000000f;--sq-row-2:#0000000a;--sq-row-3:#00000014;--sq-row-border:#5a506026;--sq-dot-empty-bg:#5a50601f;--sq-dot-empty-border:#5a506040}.die-inline{color:#26869d;cursor:pointer;border-bottom:1px solid #26869d;font-weight:700}@property --tw-rotate-x{syntax:"*";inherits:false}@property --tw-rotate-y{syntax:"*";inherits:false}@property --tw-rotate-z{syntax:"*";inherits:false}@property --tw-skew-x{syntax:"*";inherits:false}@property --tw-skew-y{syntax:"*";inherits:false}@property --tw-border-style{syntax:"*";inherits:false;initial-value:solid}@property --tw-ordinal{syntax:"*";inherits:false}@property --tw-slashed-zero{syntax:"*";inherits:false}@property --tw-numeric-figure{syntax:"*";inherits:false}@property --tw-numeric-spacing{syntax:"*";inherits:false}@property --tw-numeric-fraction{syntax:"*";inherits:false}@property --tw-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-shadow-color{syntax:"*";inherits:false}@property --tw-shadow-alpha{syntax:"<percentage>";inherits:false;initial-value:100%}@property --tw-inset-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-inset-shadow-color{syntax:"*";inherits:false}@property --tw-inset-shadow-alpha{syntax:"<percentage>";inherits:false;initial-value:100%}@property --tw-ring-color{syntax:"*";inherits:false}@property --tw-ring-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-inset-ring-color{syntax:"*";inherits:false}@property --tw-inset-ring-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-ring-inset{syntax:"*";inherits:false}@property --tw-ring-offset-width{syntax:"<length>";inherits:false;initial-value:0}@property --tw-ring-offset-color{syntax:"*";inherits:false;initial-value:#fff}@property --tw-ring-offset-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-outline-style{syntax:"*";inherits:false;initial-value:solid}@property --tw-blur{syntax:"*";inherits:false}@property --tw-brightness{syntax:"*";inherits:false}@property --tw-contrast{syntax:"*";inherits:false}@property --tw-grayscale{syntax:"*";inherits:false}@property --tw-hue-rotate{syntax:"*";inherits:false}@property --tw-invert{syntax:"*";inherits:false}@property --tw-opacity{syntax:"*";inherits:false}@property --tw-saturate{syntax:"*";inherits:false}@property --tw-sepia{syntax:"*";inherits:false}@property --tw-drop-shadow{syntax:"*";inherits:false}@property --tw-drop-shadow-color{syntax:"*";inherits:false}@property --tw-drop-shadow-alpha{syntax:"<percentage>";inherits:false;initial-value:100%}@property --tw-drop-shadow-size{syntax:"*";inherits:false}@property --tw-backdrop-blur{syntax:"*";inherits:false}@property --tw-backdrop-brightness{syntax:"*";inherits:false}@property --tw-backdrop-contrast{syntax:"*";inherits:false}@property --tw-backdrop-grayscale{syntax:"*";inherits:false}@property --tw-backdrop-hue-rotate{syntax:"*";inherits:false}@property --tw-backdrop-invert{syntax:"*";inherits:false}@property --tw-backdrop-opacity{syntax:"*";inherits:false}@property --tw-backdrop-saturate{syntax:"*";inherits:false}@property --tw-backdrop-sepia{syntax:"*";inherits:false}';var Ro=w("<style>"),Do=w("<div style=height:100%;display:flex;flex-direction:column;overflow:hidden;position:relative><div style=flex:1;overflow-y:auto;min-height:0>");function $o(n){const{state:e,setState:t,setEnergy:o,loadFromStorage:a,saveCharacter:r,loadCharacter:i}=fn(),[s,l]=V(!1),c=H(()=>{if(!n.content)return null;try{return JSON.parse(n.content)}catch{return null}});Ot(()=>{a()}),ye(()=>{if(n.character)try{const d=JSON.parse(n.character);t({...d})}catch{}});function u(d){n.element.dispatchEvent(new CustomEvent("abilityactivate",{detail:{title:d.title,energyCost:d.energyCost},bubbles:!0,composed:!0}))}return ye(()=>{e.personality?n.element.setAttribute("data-personality",e.personality):n.element.removeAttribute("data-personality")}),ye(()=>{n.element.dispatchEvent(new CustomEvent("characterchange",{detail:{name:e.name,class:e.class,profession:e.profession,personality:e.personality,die:e.die},bubbles:!0,composed:!0}))}),[(()=>{var d=Ro();return p(d,Ao),d})(),(()=>{var d=Do(),f=d.firstChild;return p(d,m(vn,{get hp(){return e.hp},get energy(){return e.energy},get name(){return e.name},get charClass(){return e.class},get profession(){return e.profession},get personality(){return e.personality},onHpChange:h=>t("hp",h),onEnergyClick:o}),f),p(d,m(Cn,{get name(){return e.name},get personality(){return e.personality},get charClass(){return e.class},get profession(){return e.profession},get personalities(){var h;return((h=c())==null?void 0:h.personalities)??[]},get classes(){var h;return((h=c())==null?void 0:h.classes)??[]},get professions(){var h;return((h=c())==null?void 0:h.professions)??[]},onNameChange:h=>t("name",h),onPersonalityChange:h=>t("personality",h),onClassChange:h=>t("class",h),onProfessionChange:h=>t("profession",h)}),f),p(d,m(An,{get combat(){return e.combat},get statuses(){var h;return((h=c())==null?void 0:h.statuses)??[]},onChange:h=>t("combat",h)}),f),p(f,m(wo,{get abilities(){var h;return((h=c())==null?void 0:h.abilities)??[]},get descriptions(){var h;return((h=c())==null?void 0:h.descriptions)??{}},get deathContent(){var h;return((h=c())==null?void 0:h.deathContent)??""},get charClass(){return e.class},get profession(){return e.profession},get personality(){return e.personality},get combat(){return e.combat},get usedAbilities(){return e.usedAbilities??[]},get selectedAbility(){return e.selectedAbility??null},onActivate:u}),null),p(f,m(Co,{get enabled(){return e.gmMode},get characterName(){return e.name},get savedCharacters(){return e.savedCharacters},onToggle:h=>t("gmMode",h),onSave:r,onLoad:i,onHelpOpen:()=>l(!0)}),null),p(d,m(oe,{get when(){return s()},get children(){return m(So,{get body(){var h;return((h=c())==null?void 0:h.generalContent)??""},onClose:()=>l(!1)})}}),null),d})()]}const qo={personalities:["passionate","wild","calculating","righteous","selfish"],classes:["wizard","sage","fighter","marksman","monk"],professions:["animal-trainer","criminal","diplomat","merchant","performer","priest","scout","soldier","tinkerer","warlock"],statuses:[{id:"inGeneral",label:"General",message:"Standard rules apply."},{id:"inCombat",label:"In Combat",message:"Combat is active. Initiative counts."},{id:"outOfCombat",label:"Out of Combat",message:"No enemies nearby."},{id:"isDead",label:"Dead",message:"You have 0 HP. Move up to 3 squares per turn. Use your Dying ability or Resuscitate."}],descriptions:{passionate:`"My name is Inigo Montoya. You killed my father. Prepare to die."
...
* _20_ Your spirit friend will aid you in an upcoming battle. It is a non-elite NPC that takes verbal instructions on its turn from you.`,context:"outOfCombat",source:"warlock"}]};return rn("simple-quest",{content:"",character:""},(n,{element:e})=>m($o,{get content(){return n.content},get character(){return n.character},element:e}),{shadow:!0}),C.sampleContent=qo,Object.defineProperty(C,Symbol.toStringTag,{value:"Module"}),C})({});
