var SimpleQuest=(function(_){"use strict";var Oo=Object.defineProperty;var Dt=_=>{throw TypeError(_)};var Io=(_,T,z)=>T in _?Oo(_,T,{enumerable:!0,configurable:!0,writable:!0,value:z}):_[T]=z;var w=(_,T,z)=>Io(_,typeof T!="symbol"?T+"":T,z),Po=(_,T,z)=>T.has(_)||Dt("Cannot "+z);var Et=(_,T,z)=>T.has(_)?Dt("Cannot add the same private member more than once"):T instanceof WeakSet?T.add(_):T.set(_,z);var De=(_,T,z)=>(Po(_,T,"access private method"),z);var V,Qe,qt;const z=(n,e)=>n===e,G=Symbol("solid-proxy"),Ee=Symbol("solid-track"),fe={equals:z};let Ve=tt;const M=1,pe=2,Xe={owned:null,cleanups:null,context:null,owner:null};var C=null;let qe=null,zt=null,v=null,R=null,N=null,ge=0;function ye(n,e){const t=v,o=C,a=n.length===0,r=e===void 0?o:e,i=a?Xe:{owned:null,cleanups:null,context:r?r.context:null,owner:r},s=a?n:()=>n(()=>B(()=>oe(i)));C=i,v=null;try{return X(s,!0)}finally{v=t,C=o}}function U(n,e){e=e?Object.assign({},fe,e):fe;const t={value:n,observers:null,observerSlots:null,comparator:e.equals||void 0},o=a=>(typeof a=="function"&&(a=a(t.value)),et(t,a));return[Je.bind(t),o]}function S(n,e,t){const o=Ye(n,e,!1,M);ne(o)}function te(n,e,t){Ve=jt;const o=Ye(n,e,!1,M);o.user=!0,N?N.push(o):ne(o)}function H(n,e,t){t=t?Object.assign({},fe,t):fe;const o=Ye(n,e,!0,0);return o.observers=null,o.observerSlots=null,o.comparator=t.equals||void 0,ne(o),Je.bind(o)}function Yt(n){return X(n,!1)}function B(n){if(v===null)return n();const e=v;v=null;try{return n()}finally{v=e}}function Ot(n,e,t){const o=Array.isArray(n);let a,r=t&&t.defer;return i=>{let s;if(o){s=Array(n.length);for(let c=0;c<n.length;c++)s[c]=n[c]()}else s=n();if(r)return r=!1,i;const l=B(()=>e(s,a,i));return a=s,l}}function It(n){te(()=>B(n))}function Pt(n){return C===null||(C.cleanups===null?C.cleanups=[n]:C.cleanups.push(n)),n}function ze(){return v}function Je(){if(this.sources&&this.state)if(this.state===M)ne(this);else{const n=R;R=null,X(()=>be(this),!1),R=n}if(v){const n=this.observers?this.observers.length:0;v.sources?(v.sources.push(this),v.sourceSlots.push(n)):(v.sources=[this],v.sourceSlots=[n]),this.observers?(this.observers.push(v),this.observerSlots.push(v.sources.length-1)):(this.observers=[v],this.observerSlots=[v.sources.length-1])}return this.value}function et(n,e,t){let o=n.value;return(!n.comparator||!n.comparator(o,e))&&(n.value=e,n.observers&&n.observers.length&&X(()=>{for(let a=0;a<n.observers.length;a+=1){const r=n.observers[a],i=qe&&qe.running;i&&qe.disposed.has(r),(i?!r.tState:!r.state)&&(r.pure?R.push(r):N.push(r),r.observers&&nt(r)),i||(r.state=M)}if(R.length>1e6)throw R=[],new Error},!1)),e}function ne(n){if(!n.fn)return;oe(n);const e=ge;Nt(n,n.value,e)}function Nt(n,e,t){let o;const a=C,r=v;v=C=n;try{o=n.fn(e)}catch(i){return n.pure&&(n.state=M,n.owned&&n.owned.forEach(oe),n.owned=null),n.updatedAt=t+1,ot(i)}finally{v=r,C=a}(!n.updatedAt||n.updatedAt<=t)&&(n.updatedAt!=null&&"observers"in n?et(n,o):n.value=o,n.updatedAt=t)}function Ye(n,e,t,o=M,a){const r={fn:n,state:o,updatedAt:null,owned:null,sources:null,sourceSlots:null,cleanups:null,value:e,owner:C,context:C?C.context:null,pure:t};return C===null||C!==Xe&&(C.owned?C.owned.push(r):C.owned=[r]),r}function me(n){if(n.state===0)return;if(n.state===pe)return be(n);if(n.suspense&&B(n.suspense.inFallback))return n.suspense.effects.push(n);const e=[n];for(;(n=n.owner)&&(!n.updatedAt||n.updatedAt<ge);)n.state&&e.push(n);for(let t=e.length-1;t>=0;t--)if(n=e[t],n.state===M)ne(n);else if(n.state===pe){const o=R;R=null,X(()=>be(n,e[0]),!1),R=o}}function X(n,e){if(R)return n();let t=!1;e||(R=[]),N?t=!0:N=[],ge++;try{const o=n();return Lt(t),o}catch(o){t||(N=null),R=null,ot(o)}}function Lt(n){if(R&&(tt(R),R=null),n)return;const e=N;N=null,e.length&&X(()=>Ve(e),!1)}function tt(n){for(let e=0;e<n.length;e++)me(n[e])}function jt(n){let e,t=0;for(e=0;e<n.length;e++){const o=n[e];o.user?n[t++]=o:me(o)}for(e=0;e<t;e++)me(n[e])}function be(n,e){n.state=0;for(let t=0;t<n.sources.length;t+=1){const o=n.sources[t];if(o.sources){const a=o.state;a===M?o!==e&&(!o.updatedAt||o.updatedAt<ge)&&me(o):a===pe&&be(o,e)}}}function nt(n){for(let e=0;e<n.observers.length;e+=1){const t=n.observers[e];t.state||(t.state=pe,t.pure?R.push(t):N.push(t),t.observers&&nt(t))}}function oe(n){let e;if(n.sources)for(;n.sources.length;){const t=n.sources.pop(),o=n.sourceSlots.pop(),a=t.observers;if(a&&a.length){const r=a.pop(),i=t.observerSlots.pop();o<a.length&&(r.sourceSlots[i]=o,a[o]=r,t.observerSlots[o]=i)}}if(n.tOwned){for(e=n.tOwned.length-1;e>=0;e--)oe(n.tOwned[e]);delete n.tOwned}if(n.owned){for(e=n.owned.length-1;e>=0;e--)oe(n.owned[e]);n.owned=null}if(n.cleanups){for(e=n.cleanups.length-1;e>=0;e--)n.cleanups[e]();n.cleanups=null}n.state=0}function Mt(n){return n instanceof Error?n:new Error(typeof n=="string"?n:"Unknown error",{cause:n})}function ot(n,e=C){throw Mt(n)}const Ht=Symbol("fallback");function at(n){for(let e=0;e<n.length;e++)n[e]()}function Bt(n,e,t={}){let o=[],a=[],r=[],i=0,s=e.length>1?[]:null;return Pt(()=>at(r)),()=>{let l=n()||[],c=l.length,u,d;return l[Ee],B(()=>{let p,x,f,$,F,E,q,Y,P;if(c===0)i!==0&&(at(r),r=[],o=[],a=[],i=0,s&&(s=[])),t.fallback&&(o=[Ht],a[0]=ye(Yo=>(r[0]=Yo,t.fallback())),i=1);else if(i===0){for(a=new Array(c),d=0;d<c;d++)o[d]=l[d],a[d]=ye(h);i=c}else{for(f=new Array(c),$=new Array(c),s&&(F=new Array(c)),E=0,q=Math.min(i,c);E<q&&o[E]===l[E];E++);for(q=i-1,Y=c-1;q>=E&&Y>=E&&o[q]===l[Y];q--,Y--)f[Y]=a[q],$[Y]=r[q],s&&(F[Y]=s[q]);for(p=new Map,x=new Array(Y+1),d=Y;d>=E;d--)P=l[d],u=p.get(P),x[d]=u===void 0?-1:u,p.set(P,d);for(u=E;u<=q;u++)P=o[u],d=p.get(P),d!==void 0&&d!==-1?(f[d]=a[u],$[d]=r[u],s&&(F[d]=s[u]),d=x[d],p.set(P,d)):r[u]();for(d=E;d<c;d++)d in f?(a[d]=f[d],r[d]=$[d],s&&(s[d]=F[d],s[d](d))):a[d]=ye(h);a=a.slice(0,i=c),o=l.slice(0)}return a});function h(p){if(r[d]=p,s){const[x,f]=U(d);return s[d]=f,e(l[d],x)}return e(l[d])}}}function b(n,e){return B(()=>n(e||{}))}const Ft=n=>`Stale read from <${n}>.`;function W(n){const e="fallback"in n&&{fallback:()=>n.fallback};return H(Bt(()=>n.each,n.children,e||void 0))}function ae(n){const e=n.keyed,t=H(()=>n.when,void 0,void 0),o=e?t:H(t,void 0,{equals:(a,r)=>!a==!r});return H(()=>{const a=o();if(a){const r=n.children;return typeof r=="function"&&r.length>0?B(()=>r(e?a:()=>{if(!B(o))throw Ft("Show");return t()})):r}return n.fallback},void 0,void 0)}const L=n=>H(()=>n());function Gt(n,e,t){let o=t.length,a=e.length,r=o,i=0,s=0,l=e[a-1].nextSibling,c=null;for(;i<a||s<r;){if(e[i]===t[s]){i++,s++;continue}for(;e[a-1]===t[r-1];)a--,r--;if(a===i){const u=r<o?s?t[s-1].nextSibling:t[r-s]:l;for(;s<r;)n.insertBefore(t[s++],u)}else if(r===s)for(;i<a;)(!c||!c.has(e[i]))&&e[i].remove(),i++;else if(e[i]===t[r-1]&&t[s]===e[a-1]){const u=e[--a].nextSibling;n.insertBefore(t[s++],e[i++].nextSibling),n.insertBefore(t[--r],u),e[a]=t[r]}else{if(!c){c=new Map;let d=s;for(;d<r;)c.set(t[d],d++)}const u=c.get(e[i]);if(u!=null)if(s<u&&u<r){let d=i,h=1,p;for(;++d<a&&d<r&&!((p=c.get(e[d]))==null||p!==u+h);)h++;if(h>u-s){const x=e[i];for(;s<u;)n.insertBefore(t[s++],x)}else n.replaceChild(t[s++],e[i++])}else i++;else e[i++].remove()}}}const rt="_$DX_DELEGATE";function k(n,e,t,o){let a;const r=()=>{const s=document.createElement("template");return s.innerHTML=n,s.content.firstChild},i=()=>(a||(a=r())).cloneNode(!0);return i.cloneNode=i,i}function Z(n,e=window.document){const t=e[rt]||(e[rt]=new Set);for(let o=0,a=n.length;o<a;o++){const r=n[o];t.has(r)||(t.add(r),e.addEventListener(r,Wt))}}function Ut(n,e,t){n.removeAttribute(e)}function Oe(n,e,t,o){Array.isArray(t)?(n[`$$${e}`]=t[0],n[`$$${e}Data`]=t[1]):n[`$$${e}`]=t}function we(n,e,t){if(!e)return t?Ut(n,"style"):e;const o=n.style;if(typeof e=="string")return o.cssText=e;typeof t=="string"&&(o.cssText=t=void 0),t||(t={}),e||(e={});let a,r;for(r in t)e[r]==null&&o.removeProperty(r),delete t[r];for(r in e)a=e[r],a!==t[r]&&(o.setProperty(r,a),t[r]=a);return t}function A(n,e,t){t!=null?n.style.setProperty(e,t):n.style.removeProperty(e)}function g(n,e,t,o){if(t!==void 0&&!o&&(o=[]),typeof e!="function")return ke(n,e,o,t);S(a=>ke(n,e(),a,t),o)}function Wt(n){let e=n.target;const t=`$$${n.type}`,o=n.target,a=n.currentTarget,r=l=>Object.defineProperty(n,"target",{configurable:!0,value:l}),i=()=>{const l=e[t];if(l&&!e.disabled){const c=e[`${t}Data`];if(c!==void 0?l.call(e,c,n):l.call(e,n),n.cancelBubble)return}return e.host&&typeof e.host!="string"&&!e.host._$host&&e.contains(n.target)&&r(e.host),!0},s=()=>{for(;i()&&(e=e._$host||e.parentNode||e.host););};if(Object.defineProperty(n,"currentTarget",{configurable:!0,get(){return e||document}}),n.composedPath){const l=n.composedPath();r(l[0]);for(let c=0;c<l.length-2&&(e=l[c],!!i());c++){if(e._$host){e=e._$host,s();break}if(e.parentNode===a)break}}else s();r(o)}function ke(n,e,t,o,a){for(;typeof t=="function";)t=t();if(e===t)return t;const r=typeof e,i=o!==void 0;if(n=i&&t[0]&&t[0].parentNode||n,r==="string"||r==="number"){if(r==="number"&&(e=e.toString(),e===t))return t;if(i){let s=t[0];s&&s.nodeType===3?s.data!==e&&(s.data=e):s=document.createTextNode(e),t=J(n,t,o,s)}else t!==""&&typeof t=="string"?t=n.firstChild.data=e:t=n.textContent=e}else if(e==null||r==="boolean")t=J(n,t,o);else{if(r==="function")return S(()=>{let s=e();for(;typeof s=="function";)s=s();t=ke(n,s,t,o)}),()=>t;if(Array.isArray(e)){const s=[],l=t&&Array.isArray(t);if(Ie(s,e,t,a))return S(()=>t=ke(n,s,t,o,!0)),()=>t;if(s.length===0){if(t=J(n,t,o),i)return t}else l?t.length===0?it(n,s,o):Gt(n,t,s):(t&&J(n),it(n,s));t=s}else if(e.nodeType){if(Array.isArray(t)){if(i)return t=J(n,t,o,e);J(n,t,null,e)}else t==null||t===""||!n.firstChild?n.appendChild(e):n.replaceChild(e,n.firstChild);t=e}}return t}function Ie(n,e,t,o){let a=!1;for(let r=0,i=e.length;r<i;r++){let s=e[r],l=t&&t[n.length],c;if(!(s==null||s===!0||s===!1))if((c=typeof s)=="object"&&s.nodeType)n.push(s);else if(Array.isArray(s))a=Ie(n,s,l)||a;else if(c==="function")if(o){for(;typeof s=="function";)s=s();a=Ie(n,Array.isArray(s)?s:[s],Array.isArray(l)?l:[l])||a}else n.push(s),a=!0;else{const u=String(s);l&&l.nodeType===3&&l.data===u?n.push(l):n.push(document.createTextNode(u))}}return a}function it(n,e,t=null){for(let o=0,a=e.length;o<a;o++)n.insertBefore(e[o],t)}function J(n,e,t,o){if(t===void 0)return n.textContent="";const a=o||document.createTextNode("");if(e.length){let r=!1;for(let i=e.length-1;i>=0;i--){const s=e[i];if(a!==s){const l=s.parentNode===n;!r&&!i?l?n.replaceChild(a,s):n.insertBefore(a,t):l&&s.remove()}else r=!0}}else n.insertBefore(a,t);return[a]}function Zt(n){return Object.keys(n).reduce((t,o)=>{const a=n[o];return t[o]=Object.assign({},a),ct(a.value)&&!Jt(a.value)&&!Array.isArray(a.value)&&(t[o].value=Object.assign({},a.value)),Array.isArray(a.value)&&(t[o].value=a.value.slice(0)),t},{})}function Kt(n){return n?Object.keys(n).reduce((t,o)=>{const a=n[o];return t[o]=ct(a)&&"value"in a?a:{value:a},t[o].attribute||(t[o].attribute=Xt(o)),t[o].parse="parse"in t[o]?t[o].parse:typeof t[o].value!="string",t},{}):{}}function Qt(n){return Object.keys(n).reduce((t,o)=>(t[o]=n[o].value,t),{})}function Vt(n,e){const t=Zt(e);return Object.keys(e).forEach(a=>{const r=t[a],i=n.getAttribute(r.attribute),s=n[a];i!=null&&(r.value=r.parse?st(i):i),s!=null&&(r.value=Array.isArray(s)?s.slice(0):s),r.reflect&&lt(n,r.attribute,r.value,!!r.parse),Object.defineProperty(n,a,{get(){return r.value},set(l){const c=r.value;r.value=l,r.reflect&&lt(this,r.attribute,r.value,!!r.parse);for(let u=0,d=this.__propertyChangedCallbacks.length;u<d;u++)this.__propertyChangedCallbacks[u](a,l,c)},enumerable:!0,configurable:!0})}),t}function st(n){if(n)try{return JSON.parse(n)}catch{return n}}function lt(n,e,t,o){if(t==null||t===!1)return n.removeAttribute(e);let a=o?JSON.stringify(t):t;n.__updating[e]=!0,a==="true"&&(a=""),n.setAttribute(e,a),Promise.resolve().then(()=>delete n.__updating[e])}function Xt(n){return n.replace(/\.?([A-Z]+)/g,(e,t)=>"-"+t.toLowerCase()).replace("_","-").replace(/^-/,"")}function ct(n){return n!=null&&(typeof n=="object"||typeof n=="function")}function Jt(n){return Object.prototype.toString.call(n)==="[object Function]"}function en(n){return typeof n=="function"&&n.toString().indexOf("class")===0}let Pe;function tn(n,e){const t=Object.keys(e);return class extends n{static get observedAttributes(){return t.map(a=>e[a].attribute)}constructor(){super(),this.__initialized=!1,this.__released=!1,this.__releaseCallbacks=[],this.__propertyChangedCallbacks=[],this.__updating={},this.props={};for(let a of t)this[a]=void 0}connectedCallback(){if(this.__initialized)return;this.__releaseCallbacks=[],this.__propertyChangedCallbacks=[],this.__updating={},this.props=Vt(this,e);const a=Qt(this.props),r=this.Component,i=Pe;try{Pe=this,this.__initialized=!0,en(r)?new r(a,{element:this}):r(a,{element:this})}finally{Pe=i}}async disconnectedCallback(){if(await Promise.resolve(),this.isConnected)return;this.__propertyChangedCallbacks.length=0;let a=null;for(;a=this.__releaseCallbacks.pop();)a(this);delete this.__initialized,this.__released=!0}attributeChangedCallback(a,r,i){if(this.__initialized&&!this.__updating[a]&&(a=this.lookupProp(a),a in e)){if(i==null&&!this[a])return;this[a]=e[a].parse?st(i):i}}lookupProp(a){if(e)return t.find(r=>a===r||a===e[r].attribute)}get renderRoot(){return this.shadowRoot||this.attachShadow({mode:"open"})}addReleaseCallback(a){this.__releaseCallbacks.push(a)}addPropertyChangedCallback(a){this.__propertyChangedCallbacks.push(a)}}}function nn(n,e={},t={}){const{BaseElement:o=HTMLElement,extension:a,customElements:r=window.customElements}=t;return i=>{let s=r.get(n);return s?(s.prototype.Component=i,s):(s=tn(o,Kt(e)),s.prototype.Component=i,s.prototype.registeredTag=n,r.define(n,s,a),s)}}function on(n){const e=Object.keys(n),t={};for(let o=0;o<e.length;o++){const[a,r]=U(n[e[o]]);Object.defineProperty(t,e[o],{get:a,set(i){r(()=>i)}})}return t}function an(n){if(n.assignedSlot&&n.assignedSlot._$owner)return n.assignedSlot._$owner;let e=n.parentNode;for(;e&&!e._$owner&&!(e.assignedSlot&&e.assignedSlot._$owner);)e=e.parentNode;return e&&e.assignedSlot?e.assignedSlot._$owner:n._$owner}function rn(n){return(e,t)=>{const{element:o}=t;return ye(a=>{const r=on(e);o.addPropertyChangedCallback((s,l)=>r[s]=l),o.addReleaseCallback(()=>{o.renderRoot.textContent="",a()});const i=n(r,t);return g(o.renderRoot,i)},an(o))}}function sn(n,e,t){return arguments.length===2&&(t=e,e={}),nn(n,e)(rn(t))}const Ne=Symbol("store-raw"),ee=Symbol("store-node"),j=Symbol("store-has"),ut=Symbol("store-self");function dt(n){let e=n[G];if(!e&&(Object.defineProperty(n,G,{value:e=new Proxy(n,un)}),!Array.isArray(n))){const t=Object.keys(n),o=Object.getOwnPropertyDescriptors(n);for(let a=0,r=t.length;a<r;a++){const i=t[a];o[i].get&&Object.defineProperty(n,i,{enumerable:o[i].enumerable,get:o[i].get.bind(e)})}}return e}function xe(n){let e;return n!=null&&typeof n=="object"&&(n[G]||!(e=Object.getPrototypeOf(n))||e===Object.prototype||Array.isArray(n))}function re(n,e=new Set){let t,o,a,r;if(t=n!=null&&n[Ne])return t;if(!xe(n)||e.has(n))return n;if(Array.isArray(n)){Object.isFrozen(n)?n=n.slice(0):e.add(n);for(let i=0,s=n.length;i<s;i++)a=n[i],(o=re(a,e))!==a&&(n[i]=o)}else{Object.isFrozen(n)?n=Object.assign({},n):e.add(n);const i=Object.keys(n),s=Object.getOwnPropertyDescriptors(n);for(let l=0,c=i.length;l<c;l++)r=i[l],!s[r].get&&(a=n[r],(o=re(a,e))!==a&&(n[r]=o))}return n}function ve(n,e){let t=n[e];return t||Object.defineProperty(n,e,{value:t=Object.create(null)}),t}function ie(n,e,t){if(n[e])return n[e];const[o,a]=U(t,{equals:!1,internal:!0});return o.$=a,n[e]=o}function ln(n,e){const t=Reflect.getOwnPropertyDescriptor(n,e);return!t||t.get||!t.configurable||e===G||e===ee||(delete t.value,delete t.writable,t.get=()=>n[G][e]),t}function ht(n){ze()&&ie(ve(n,ee),ut)()}function cn(n){return ht(n),Reflect.ownKeys(n)}const un={get(n,e,t){if(e===Ne)return n;if(e===G)return t;if(e===Ee)return ht(n),t;const o=ve(n,ee),a=o[e];let r=a?a():n[e];if(e===ee||e===j||e==="__proto__")return r;if(!a){const i=Object.getOwnPropertyDescriptor(n,e);ze()&&(typeof r!="function"||n.hasOwnProperty(e))&&!(i&&i.get)&&(r=ie(o,e,r)())}return xe(r)?dt(r):r},has(n,e){return e===Ne||e===G||e===Ee||e===ee||e===j||e==="__proto__"?!0:(ze()&&ie(ve(n,j),e)(),e in n)},set(){return!0},deleteProperty(){return!0},ownKeys:cn,getOwnPropertyDescriptor:ln};function _e(n,e,t,o=!1){if(!o&&n[e]===t)return;const a=n[e],r=n.length;t===void 0?(delete n[e],n[j]&&n[j][e]&&a!==void 0&&n[j][e].$()):(n[e]=t,n[j]&&n[j][e]&&a===void 0&&n[j][e].$());let i=ve(n,ee),s;if((s=ie(i,e,a))&&s.$(()=>t),Array.isArray(n)&&n.length!==r){for(let l=n.length;l<r;l++)(s=i[l])&&s.$();(s=ie(i,"length",r))&&s.$(n.length)}(s=i[ut])&&s.$()}function ft(n,e){const t=Object.keys(e);for(let o=0;o<t.length;o+=1){const a=t[o];_e(n,a,e[a])}}function dn(n,e){if(typeof e=="function"&&(e=e(n)),e=re(e),Array.isArray(e)){if(n===e)return;let t=0,o=e.length;for(;t<o;t++){const a=e[t];n[t]!==a&&_e(n,t,a)}_e(n,"length",o)}else ft(n,e)}function se(n,e,t=[]){let o,a=n;if(e.length>1){o=e.shift();const i=typeof o,s=Array.isArray(n);if(Array.isArray(o)){for(let l=0;l<o.length;l++)se(n,[o[l]].concat(e),t);return}else if(s&&i==="function"){for(let l=0;l<n.length;l++)o(n[l],l)&&se(n,[l].concat(e),t);return}else if(s&&i==="object"){const{from:l=0,to:c=n.length-1,by:u=1}=o;for(let d=l;d<=c;d+=u)se(n,[d].concat(e),t);return}else if(e.length>1){se(n[o],e,[o].concat(t));return}a=n[o],t=[o].concat(t)}let r=e[0];typeof r=="function"&&(r=r(a,t),r===a)||o===void 0&&r==null||(r=re(r),o===void 0||xe(a)&&xe(r)&&!Array.isArray(r)?ft(a,r):_e(n,o,r))}function hn(...[n,e]){const t=re(n||{}),o=Array.isArray(t),a=dt(t);function r(...i){Yt(()=>{o&&i.length===1?dn(t,i[0]):se(t,i)})}return[a,r]}const pt="simplequest-characters",fn={name:"",personality:"",class:"",profession:"",combat:"inGeneral",energy:Array(10).fill(!1),hp:0,die:"d6",round:0,gmMode:!1,savedCharacters:{}};function pn(){const[n,e]=hn(structuredClone(fn));function t(i){e("energy",s=>s.map((l,c)=>c<=i))}function o(){try{const i=localStorage.getItem(pt);i&&e("savedCharacters",JSON.parse(i))}catch{}}function a(){if(!n.name)return;const{gmMode:i,savedCharacters:s,...l}=n,c={...n.savedCharacters,[n.name]:l};e("savedCharacters",c);try{localStorage.setItem(pt,JSON.stringify(c))}catch{}}function r(i){const s=n.savedCharacters[i];s&&e({...s})}return{state:n,setState:e,setEnergy:t,loadFromStorage:o,saveCharacter:a,loadCharacter:r}}var gn=k('<div style=display:flex;align-items:center;gap:6px><label style=color:var(--sq-overlay-text-muted);font-size:12px;text-transform:uppercase;letter-spacing:1px>HP</label><select style="background:var(--sq-ctrl-bg);border:1px solid var(--sq-ctrl-border);color:var(--sq-ctrl-text);border-radius:4px;padding:4px 8px;font-size:13px;font-family:inherit;cursor:pointer">'),yn=k("<option>");function mn(n){const e=Array.from({length:31},(t,o)=>o);return(()=>{var t=gn(),o=t.firstChild,a=o.nextSibling;return a.addEventListener("change",r=>n.onHpChange(parseInt(r.currentTarget.value,10))),g(a,()=>e.map(r=>(()=>{var i=yn();return i.value=r,g(i,r),i})())),S(()=>a.value=n.hp),t})()}var bn=k("<div style=display:flex;gap:5px;align-items:center>"),wn=k('<div style="width:14px;height:14px;border-radius:50%;cursor:pointer;transition:background 0.15s, border-color 0.15s">');function kn(n){return(()=>{var e=bn();return g(e,b(W,{get each(){return n.energy},children:(t,o)=>(()=>{var a=wn();return a.$$click=()=>n.onEnergyClick(o()),A(a,"background",t?"var(--sq-overlay-text)":"var(--sq-dot-empty-bg)"),A(a,"border",`2px solid ${t?"var(--sq-overlay-text)":"var(--sq-dot-empty-border)"}`),a})()})),e})()}Z(["click"]);var xn=k('<div style="background:var(--sq-row-1);border-bottom:1px solid var(--sq-row-border);position:sticky;top:0;z-index:100"><div style="padding:8px 14px 2px;font-size:13px;color:var(--sq-ctrl-text);text-transform:capitalize;user-select:none;-webkit-user-select:none;white-space:nowrap;overflow:hidden;text-overflow:ellipsis"></div><div style="padding:4px 14px 10px;display:flex;align-items:center;gap:12px;flex-wrap:wrap">');function vn(n){const e=()=>[n.name,n.charClass,n.profession,n.personality].filter(Boolean).join(" · ");return(()=>{var t=xn(),o=t.firstChild,a=o.nextSibling;return g(o,e),g(a,b(mn,{get hp(){return n.hp},get onHpChange(){return n.onHpChange}}),null),g(a,b(kn,{get energy(){return n.energy},get onEnergyClick(){return n.onEnergyClick}}),null),t})()}var _n=k('<div style="background:var(--sq-row-2);border-bottom:1px solid var(--sq-row-border);padding:10px 14px;display:flex;gap:8px;flex-wrap:wrap"><input type=text placeholder="Character name"><select><option value>Personality</option></select><select><option value>Class</option></select><select><option value>Profession'),Le=k("<option>");const je={background:"var(--sq-ctrl-bg)",border:"1px solid var(--sq-ctrl-border)",color:"var(--sq-ctrl-text)","border-radius":"4px",padding:"5px 8px","font-size":"13px","font-family":"inherit",cursor:"pointer",flex:"1","min-width":"0","text-transform":"capitalize"},Cn={background:"var(--sq-ctrl-bg)",border:"1px solid var(--sq-ctrl-border)",color:"var(--sq-ctrl-text)","border-radius":"4px",padding:"5px 8px","font-size":"13px","font-family":"inherit",flex:"1","min-width":"0",outline:"none"};function Tn(n){return(()=>{var e=_n(),t=e.firstChild,o=t.nextSibling;o.firstChild;var a=o.nextSibling;a.firstChild;var r=a.nextSibling;return r.firstChild,t.$$input=i=>n.onNameChange(i.currentTarget.value),we(t,Cn),o.addEventListener("change",i=>n.onPersonalityChange(i.currentTarget.value)),g(o,b(W,{get each(){return n.personalities},children:i=>(()=>{var s=Le();return s.value=i,g(s,i),s})()}),null),a.addEventListener("change",i=>n.onClassChange(i.currentTarget.value)),g(a,b(W,{get each(){return n.classes},children:i=>(()=>{var s=Le();return s.value=i,g(s,i),s})()}),null),r.addEventListener("change",i=>n.onProfessionChange(i.currentTarget.value)),g(r,b(W,{get each(){return n.professions},children:i=>(()=>{var s=Le();return s.value=i,g(s,i),s})()}),null),S(i=>{var s=je,l=je,c=je;return i.e=we(o,s,i.e),i.t=we(a,l,i.t),i.a=we(r,c,i.a),i},{e:void 0,t:void 0,a:void 0}),S(()=>t.value=n.name),S(()=>o.value=n.personality),S(()=>a.value=n.charClass),S(()=>r.value=n.profession),e})()}Z(["input"]);var Sn=k('<div style="background:var(--sq-row-2);border-bottom:1px solid var(--sq-row-border);padding:8px 14px"><div style=display:flex;gap:4px;flex-wrap:wrap></div><div style=color:var(--sq-overlay-text);font-size:11px;opacity:0.7;margin-top:4px;min-height:14px>'),Rn=k('<button style="border-radius:4px;padding:4px 12px;font-size:12px;font-family:inherit;cursor:pointer;transition:all 0.1s">');function An(n){const e=H(()=>n.statuses.find(t=>t.id===n.combat));return(()=>{var t=Sn(),o=t.firstChild,a=o.nextSibling;return g(o,b(W,{get each(){return n.statuses},children:r=>{const i=()=>n.combat===r.id;return(()=>{var s=Rn();return s.$$click=()=>n.onChange(r.id),g(s,()=>r.label),S(l=>{var c=i()?"var(--sq-accent)":"var(--sq-ctrl-bg)",u=i()?"#ffffff":"var(--sq-ctrl-text)",d=`1px solid ${i()?"var(--sq-accent)":"var(--sq-ctrl-border)"}`,h=i()?"600":"400";return c!==l.e&&A(s,"background",l.e=c),u!==l.t&&A(s,"color",l.t=u),d!==l.a&&A(s,"border",l.a=d),h!==l.o&&A(s,"font-weight",l.o=h),l},{e:void 0,t:void 0,a:void 0,o:void 0}),s})()}})),g(a,()=>{var r;return((r=e())==null?void 0:r.message)??""}),t})()}Z(["click"]);function Me(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}let K=Me();function gt(n){K=n}const yt=/[&<>"']/,$n=new RegExp(yt.source,"g"),mt=/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,Dn=new RegExp(mt.source,"g"),En={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},bt=n=>En[n];function D(n,e){if(e){if(yt.test(n))return n.replace($n,bt)}else if(mt.test(n))return n.replace(Dn,bt);return n}const qn=/&(#(?:\d+)|(?:#x[0-9A-Fa-f]+)|(?:\w+));?/ig;function zn(n){return n.replace(qn,(e,t)=>(t=t.toLowerCase(),t==="colon"?":":t.charAt(0)==="#"?t.charAt(1)==="x"?String.fromCharCode(parseInt(t.substring(2),16)):String.fromCharCode(+t.substring(1)):""))}const Yn=/(^|[^\[])\^/g;function m(n,e){let t=typeof n=="string"?n:n.source;e=e||"";const o={replace:(a,r)=>{let i=typeof r=="string"?r:r.source;return i=i.replace(Yn,"$1"),t=t.replace(a,i),o},getRegex:()=>new RegExp(t,e)};return o}function wt(n){try{n=encodeURI(n).replace(/%25/g,"%")}catch{return null}return n}const le={exec:()=>null};function kt(n,e){const t=n.replace(/\|/g,(r,i,s)=>{let l=!1,c=i;for(;--c>=0&&s[c]==="\\";)l=!l;return l?"|":" |"}),o=t.split(/ \|/);let a=0;if(o[0].trim()||o.shift(),o.length>0&&!o[o.length-1].trim()&&o.pop(),e)if(o.length>e)o.splice(e);else for(;o.length<e;)o.push("");for(;a<o.length;a++)o[a]=o[a].trim().replace(/\\\|/g,"|");return o}function Ce(n,e,t){const o=n.length;if(o===0)return"";let a=0;for(;a<o&&n.charAt(o-a-1)===e;)a++;return n.slice(0,o-a)}function On(n,e){if(n.indexOf(e[1])===-1)return-1;let t=0;for(let o=0;o<n.length;o++)if(n[o]==="\\")o++;else if(n[o]===e[0])t++;else if(n[o]===e[1]&&(t--,t<0))return o;return-1}function xt(n,e,t,o){const a=e.href,r=e.title?D(e.title):null,i=n[1].replace(/\\([\[\]])/g,"$1");if(n[0].charAt(0)!=="!"){o.state.inLink=!0;const s={type:"link",raw:t,href:a,title:r,text:i,tokens:o.inlineTokens(i)};return o.state.inLink=!1,s}return{type:"image",raw:t,href:a,title:r,text:D(i)}}function In(n,e){const t=n.match(/^(\s+)(?:```)/);if(t===null)return e;const o=t[1];return e.split(`
`).map(a=>{const r=a.match(/^\s+/);if(r===null)return a;const[i]=r;return i.length>=o.length?a.slice(o.length):a}).join(`
`)}class Te{constructor(e){w(this,"options");w(this,"rules");w(this,"lexer");this.options=e||K}space(e){const t=this.rules.block.newline.exec(e);if(t&&t[0].length>0)return{type:"space",raw:t[0]}}code(e){const t=this.rules.block.code.exec(e);if(t){const o=t[0].replace(/^ {1,4}/gm,"");return{type:"code",raw:t[0],codeBlockStyle:"indented",text:this.options.pedantic?o:Ce(o,`
`)}}}fences(e){const t=this.rules.block.fences.exec(e);if(t){const o=t[0],a=In(o,t[3]||"");return{type:"code",raw:o,lang:t[2]?t[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):t[2],text:a}}}heading(e){const t=this.rules.block.heading.exec(e);if(t){let o=t[2].trim();if(/#$/.test(o)){const a=Ce(o,"#");(this.options.pedantic||!a||/ $/.test(a))&&(o=a.trim())}return{type:"heading",raw:t[0],depth:t[1].length,text:o,tokens:this.lexer.inline(o)}}}hr(e){const t=this.rules.block.hr.exec(e);if(t)return{type:"hr",raw:t[0]}}blockquote(e){const t=this.rules.block.blockquote.exec(e);if(t){let o=t[0].replace(/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,`
    $1`);o=Ce(o.replace(/^ *>[ \t]?/gm,""),`
...
`,1)[0],p=0;this.options.pedantic?(p=2,l=d.trimStart()):(p=t[2].search(/[^ ]/),p=p>4?1:p,l=d.slice(p),p+=t[1].length);let x=!1;if(!d&&/^ *$/.test(h)&&(s+=h+`
`,e=e.substring(h.length+1),u=!0),!u){const F=new RegExp(`^ {0,${Math.min(3,p-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),E=new RegExp(`^ {0,${Math.min(3,p-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),q=new RegExp(`^ {0,${Math.min(3,p-1)}}(?:\`\`\`|~~~)`),Y=new RegExp(`^ {0,${Math.min(3,p-1)}}#`);for(;e;){const P=e.split(`
`,1)[0];if(h=P,this.options.pedantic&&(h=h.replace(/^ {1,4}(?=( {4})*[^ ])/g,"  ")),q.test(h)||Y.test(h)||F.test(h)||E.test(e))break;if(h.search(/[^ ]/)>=p||!h.trim())l+=`
`+h.slice(p);else{if(x||d.search(/[^ ]/)>=4||q.test(d)||Y.test(d)||E.test(d))break;l+=`
`+h}!x&&!h.trim()&&(x=!0),s+=P+`
`,e=e.substring(P.length+1),d=h.slice(p)}}r.loose||(c?r.loose=!0:/\n *\n *$/.test(s)&&(c=!0));let f=null,$;this.options.gfm&&(f=/^\[[ xX]\] /.exec(l),f&&($=f[0]!=="[ ] ",l=l.replace(/^\[[ xX]\] +/,""))),r.items.push({type:"list_item",raw:s,task:!!f,checked:$,loose:!1,text:l,tokens:[]}),r.raw+=s}r.items[r.items.length-1].raw=s.trimEnd(),r.items[r.items.length-1].text=l.trimEnd(),r.raw=r.raw.trimEnd();for(let u=0;u<r.items.length;u++)if(this.lexer.state.top=!1,r.items[u].tokens=this.lexer.blockTokens(r.items[u].text,[]),!r.loose){const d=r.items[u].tokens.filter(p=>p.type==="space"),h=d.length>0&&d.some(p=>/\n.*\n/.test(p.raw));r.loose=h}if(r.loose)for(let u=0;u<r.items.length;u++)r.items[u].loose=!0;return r}}html(e){const t=this.rules.block.html.exec(e);if(t)return{type:"html",block:!0,raw:t[0],pre:t[1]==="pre"||t[1]==="script"||t[1]==="style",text:t[0]}}def(e){const t=this.rules.block.def.exec(e);if(t){const o=t[1].toLowerCase().replace(/\s+/g," "),a=t[2]?t[2].replace(/^<(.*)>$/,"$1").replace(this.rules.inline.anyPunctuation,"$1"):"",r=t[3]?t[3].substring(1,t[3].length-1).replace(this.rules.inline.anyPunctuation,"$1"):t[3];return{type:"def",tag:o,raw:t[0],href:a,title:r}}}table(e){const t=this.rules.block.table.exec(e);if(!t||!/[:|]/.test(t[2]))return;const o=kt(t[1]),a=t[2].replace(/^\||\| *$/g,"").split("|"),r=t[3]&&t[3].trim()?t[3].replace(/\n[ \t]*$/,"").split(`
`):[],i={type:"table",raw:t[0],header:[],align:[],rows:[]};if(o.length===a.length){for(const s of a)/^ *-+: *$/.test(s)?i.align.push("right"):/^ *:-+: *$/.test(s)?i.align.push("center"):/^ *:-+ *$/.test(s)?i.align.push("left"):i.align.push(null);for(const s of o)i.header.push({text:s,tokens:this.lexer.inline(s)});for(const s of r)i.rows.push(kt(s,i.header.length).map(l=>({text:l,tokens:this.lexer.inline(l)})));return i}}lheading(e){const t=this.rules.block.lheading.exec(e);if(t)return{type:"heading",raw:t[0],depth:t[2].charAt(0)==="="?1:2,text:t[1],tokens:this.lexer.inline(t[1])}}paragraph(e){const t=this.rules.block.paragraph.exec(e);if(t){const o=t[1].charAt(t[1].length-1)===`
`?t[1].slice(0,-1):t[1];return{type:"paragraph",raw:t[0],text:o,tokens:this.lexer.inline(o)}}}text(e){const t=this.rules.block.text.exec(e);if(t)return{type:"text",raw:t[0],text:t[0],tokens:this.lexer.inline(t[0])}}escape(e){const t=this.rules.inline.escape.exec(e);if(t)return{type:"escape",raw:t[0],text:D(t[1])}}tag(e){const t=this.rules.inline.tag.exec(e);if(t)return!this.lexer.state.inLink&&/^<a /i.test(t[0])?this.lexer.state.inLink=!0:this.lexer.state.inLink&&/^<\/a>/i.test(t[0])&&(this.lexer.state.inLink=!1),!this.lexer.state.inRawBlock&&/^<(pre|code|kbd|script)(\s|>)/i.test(t[0])?this.lexer.state.inRawBlock=!0:this.lexer.state.inRawBlock&&/^<\/(pre|code|kbd|script)(\s|>)/i.test(t[0])&&(this.lexer.state.inRawBlock=!1),{type:"html",raw:t[0],inLink:this.lexer.state.inLink,inRawBlock:this.lexer.state.inRawBlock,block:!1,text:t[0]}}link(e){const t=this.rules.inline.link.exec(e);if(t){const o=t[2].trim();if(!this.options.pedantic&&/^</.test(o)){if(!/>$/.test(o))return;const i=Ce(o.slice(0,-1),"\\");if((o.length-i.length)%2===0)return}else{const i=On(t[2],"()");if(i>-1){const l=(t[0].indexOf("!")===0?5:4)+t[1].length+i;t[2]=t[2].substring(0,i),t[0]=t[0].substring(0,l).trim(),t[3]=""}}let a=t[2],r="";if(this.options.pedantic){const i=/^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(a);i&&(a=i[1],r=i[3])}else r=t[3]?t[3].slice(1,-1):"";return a=a.trim(),/^</.test(a)&&(this.options.pedantic&&!/>$/.test(o)?a=a.slice(1):a=a.slice(1,-1)),xt(t,{href:a&&a.replace(this.rules.inline.anyPunctuation,"$1"),title:r&&r.replace(this.rules.inline.anyPunctuation,"$1")},t[0],this.lexer)}}reflink(e,t){let o;if((o=this.rules.inline.reflink.exec(e))||(o=this.rules.inline.nolink.exec(e))){const a=(o[2]||o[1]).replace(/\s+/g," "),r=t[a.toLowerCase()];if(!r){const i=o[0].charAt(0);return{type:"text",raw:i,text:i}}return xt(o,r,o[0],this.lexer)}}emStrong(e,t,o=""){let a=this.rules.inline.emStrongLDelim.exec(e);if(!a||a[3]&&o.match(/[\p{L}\p{N}]/u))return;if(!(a[1]||a[2]||"")||!o||this.rules.inline.punctuation.exec(o)){const i=[...a[0]].length-1;let s,l,c=i,u=0;const d=a[0][0]==="*"?this.rules.inline.emStrongRDelimAst:this.rules.inline.emStrongRDelimUnd;for(d.lastIndex=0,t=t.slice(-1*e.length+i);(a=d.exec(t))!=null;){if(s=a[1]||a[2]||a[3]||a[4]||a[5]||a[6],!s)continue;if(l=[...s].length,a[3]||a[4]){c+=l;continue}else if((a[5]||a[6])&&i%3&&!((i+l)%3)){u+=l;continue}if(c-=l,c>0)continue;l=Math.min(l,l+c+u);const h=[...a[0]][0].length,p=e.slice(0,i+a.index+h+l);if(Math.min(i,l)%2){const f=p.slice(1,-1);return{type:"em",raw:p,text:f,tokens:this.lexer.inlineTokens(f)}}const x=p.slice(2,-2);return{type:"strong",raw:p,text:x,tokens:this.lexer.inlineTokens(x)}}}}codespan(e){const t=this.rules.inline.code.exec(e);if(t){let o=t[2].replace(/\n/g," ");const a=/[^ ]/.test(o),r=/^ /.test(o)&&/ $/.test(o);return a&&r&&(o=o.substring(1,o.length-1)),o=D(o,!0),{type:"codespan",raw:t[0],text:o}}}br(e){const t=this.rules.inline.br.exec(e);if(t)return{type:"br",raw:t[0]}}del(e){const t=this.rules.inline.del.exec(e);if(t)return{type:"del",raw:t[0],text:t[2],tokens:this.lexer.inlineTokens(t[2])}}autolink(e){const t=this.rules.inline.autolink.exec(e);if(t){let o,a;return t[2]==="@"?(o=D(t[1]),a="mailto:"+o):(o=D(t[1]),a=o),{type:"link",raw:t[0],text:o,href:a,tokens:[{type:"text",raw:o,text:o}]}}}url(e){var o;let t;if(t=this.rules.inline.url.exec(e)){let a,r;if(t[2]==="@")a=D(t[0]),r="mailto:"+a;else{let i;do i=t[0],t[0]=((o=this.rules.inline._backpedal.exec(t[0]))==null?void 0:o[0])??"";while(i!==t[0]);a=D(t[0]),t[1]==="www."?r="http://"+t[0]:r=t[0]}return{type:"link",raw:t[0],text:a,href:r,tokens:[{type:"text",raw:a,text:a}]}}}inlineText(e){const t=this.rules.inline.text.exec(e);if(t){let o;return this.lexer.state.inRawBlock?o=t[0]:o=D(t[0]),{type:"text",raw:t[0],text:o}}}}const Pn=/^(?: *(?:\n|$))+/,Nn=/^( {4}[^\n]+(?:\n(?: *(?:\n|$))*)?)+/,Ln=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,ce=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,jn=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,vt=/(?:[*+-]|\d{1,9}[.)])/,_t=m(/^(?!bull |blockCode|fences|blockquote|heading|html)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html))+?)\n {0,3}(=+|-+) *(?:\n+|$)/).replace(/bull/g,vt).replace(/blockCode/g,/ {4}/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).getRegex(),He=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,Mn=/^[^\n]+/,Be=/(?!\s*\])(?:\\.|[^\[\]\\])+/,Hn=m(/^ {0,3}\[(label)\]: *(?:\n *)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n *)?| *\n *)(title))? *(?:\n+|$)/).replace("label",Be).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Bn=m(/^( {0,3}bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,vt).getRegex(),Se="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Fe=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Fn=m("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n *)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n *)+\\n|$))","i").replace("comment",Fe).replace("tag",Se).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Ct=m(He).replace("hr",ce).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Se).getRegex(),Ge={blockquote:m(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Ct).getRegex(),code:Nn,def:Hn,fences:Ln,heading:jn,hr:ce,html:Fn,lheading:_t,list:Bn,newline:Pn,paragraph:Ct,table:le,text:Mn},Tt=m("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",ce).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code"," {4}[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Se).getRegex(),Gn={...Ge,table:Tt,paragraph:m(He).replace("hr",ce).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",Tt).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)]) ").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Se).getRegex()},Un={...Ge,html:m(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Fe).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:le,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:m(He).replace("hr",ce).replace("heading",` *#{1,6} *[^
]`).replace("lheading",_t).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},St=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,Wn=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,Rt=/^( {2,}|\\)\n(?!\s*$)/,Zn=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,ue="\\p{P}\\p{S}",Kn=m(/^((?![*_])[\spunctuation])/,"u").replace(/punctuation/g,ue).getRegex(),Qn=/\[[^[\]]*?\]\([^\(\)]*?\)|`[^`]*?`|<[^<>]*?>/g,Vn=m(/^(?:\*+(?:((?!\*)[punct])|[^\s*]))|^_+(?:((?!_)[punct])|([^\s_]))/,"u").replace(/punct/g,ue).getRegex(),Xn=m("^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)[punct](\\*+)(?=[\\s]|$)|[^punct\\s](\\*+)(?!\\*)(?=[punct\\s]|$)|(?!\\*)[punct\\s](\\*+)(?=[^punct\\s])|[\\s](\\*+)(?!\\*)(?=[punct])|(?!\\*)[punct](\\*+)(?!\\*)(?=[punct])|[^punct\\s](\\*+)(?=[^punct\\s])","gu").replace(/punct/g,ue).getRegex(),Jn=m("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)[punct](_+)(?=[\\s]|$)|[^punct\\s](_+)(?!_)(?=[punct\\s]|$)|(?!_)[punct\\s](_+)(?=[^punct\\s])|[\\s](_+)(?!_)(?=[punct])|(?!_)[punct](_+)(?!_)(?=[punct])","gu").replace(/punct/g,ue).getRegex(),eo=m(/\\([punct])/,"gu").replace(/punct/g,ue).getRegex(),to=m(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),no=m(Fe).replace("(?:-->|$)","-->").getRegex(),oo=m("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",no).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),Re=/(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/,ao=m(/^!?\[(label)\]\(\s*(href)(?:\s+(title))?\s*\)/).replace("label",Re).replace("href",/<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),At=m(/^!?\[(label)\]\[(ref)\]/).replace("label",Re).replace("ref",Be).getRegex(),$t=m(/^!?\[(ref)\](?:\[\])?/).replace("ref",Be).getRegex(),ro=m("reflink|nolink(?!\\()","g").replace("reflink",At).replace("nolink",$t).getRegex(),Ue={_backpedal:le,anyPunctuation:eo,autolink:to,blockSkip:Qn,br:Rt,code:Wn,del:le,emStrongLDelim:Vn,emStrongRDelimAst:Xn,emStrongRDelimUnd:Jn,escape:St,link:ao,nolink:$t,punctuation:Kn,reflink:At,reflinkSearch:ro,tag:oo,text:Zn,url:le},io={...Ue,link:m(/^!?\[(label)\]\((.*?)\)/).replace("label",Re).getRegex(),reflink:m(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",Re).getRegex()},We={...Ue,escape:m(St).replace("])","~|])").getRegex(),url:m(/^((?:ftp|https?):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/,"i").replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])([\s\S]*?[^\s~])\1(?=[^~]|$)/,text:/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|https?:\/\/|ftp:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/},so={...We,br:m(Rt).replace("{2,}","*").getRegex(),text:m(We.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},Ae={normal:Ge,gfm:Gn,pedantic:Un},de={normal:Ue,gfm:We,breaks:so,pedantic:io};class O{constructor(e){w(this,"tokens");w(this,"options");w(this,"state");w(this,"tokenizer");w(this,"inlineQueue");this.tokens=[],this.tokens.links=Object.create(null),this.options=e||K,this.options.tokenizer=this.options.tokenizer||new Te,this.tokenizer=this.options.tokenizer,this.tokenizer.options=this.options,this.tokenizer.lexer=this,this.inlineQueue=[],this.state={inLink:!1,inRawBlock:!1,top:!0};const t={block:Ae.normal,inline:de.normal};this.options.pedantic?(t.block=Ae.pedantic,t.inline=de.pedantic):this.options.gfm&&(t.block=Ae.gfm,this.options.breaks?t.inline=de.breaks:t.inline=de.gfm),this.tokenizer.rules=t}static get rules(){return{block:Ae,inline:de}}static lex(e,t){return new O(t).lex(e)}static lexInline(e,t){return new O(t).inlineTokens(e)}lex(e){e=e.replace(/\r\n|\r/g,`
...
`}strong(e){return`<strong>${e}</strong>`}em(e){return`<em>${e}</em>`}codespan(e){return`<code>${e}</code>`}br(){return"<br>"}del(e){return`<del>${e}</del>`}link(e,t,o){const a=wt(e);if(a===null)return o;e=a;let r='<a href="'+e+'"';return t&&(r+=' title="'+t+'"'),r+=">"+o+"</a>",r}image(e,t,o){const a=wt(e);if(a===null)return o;e=a;let r=`<img src="${e}" alt="${o}"`;return t&&(r+=` title="${t}"`),r+=">",r}text(e){return e}}class Ze{strong(e){return e}em(e){return e}codespan(e){return e}del(e){return e}html(e){return e}text(e){return e}link(e,t,o){return""+o}image(e,t,o){return""+o}br(){return""}}class I{constructor(e){w(this,"options");w(this,"renderer");w(this,"textRenderer");this.options=e||K,this.options.renderer=this.options.renderer||new $e,this.renderer=this.options.renderer,this.renderer.options=this.options,this.textRenderer=new Ze}static parse(e,t){return new I(t).parse(e)}static parseInline(e,t){return new I(t).parseInline(e)}parse(e,t=!0){let o="";for(let a=0;a<e.length;a++){const r=e[a];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]){const i=r,s=this.options.extensions.renderers[i.type].call({parser:this},i);if(s!==!1||!["space","hr","heading","code","table","blockquote","list","html","paragraph","text"].includes(i.type)){o+=s||"";continue}}switch(r.type){case"space":continue;case"hr":{o+=this.renderer.hr();continue}case"heading":{const i=r;o+=this.renderer.heading(this.parseInline(i.tokens),i.depth,zn(this.parseInline(i.tokens,this.textRenderer)));continue}case"code":{const i=r;o+=this.renderer.code(i.text,i.lang,!!i.escaped);continue}case"table":{const i=r;let s="",l="";for(let u=0;u<i.header.length;u++)l+=this.renderer.tablecell(this.parseInline(i.header[u].tokens),{header:!0,align:i.align[u]});s+=this.renderer.tablerow(l);let c="";for(let u=0;u<i.rows.length;u++){const d=i.rows[u];l="";for(let h=0;h<d.length;h++)l+=this.renderer.tablecell(this.parseInline(d[h].tokens),{header:!1,align:i.align[h]});c+=this.renderer.tablerow(l)}o+=this.renderer.table(s,c);continue}case"blockquote":{const i=r,s=this.parse(i.tokens);o+=this.renderer.blockquote(s);continue}case"list":{const i=r,s=i.ordered,l=i.start,c=i.loose;let u="";for(let d=0;d<i.items.length;d++){const h=i.items[d],p=h.checked,x=h.task;let f="";if(h.task){const $=this.renderer.checkbox(!!p);c?h.tokens.length>0&&h.tokens[0].type==="paragraph"?(h.tokens[0].text=$+" "+h.tokens[0].text,h.tokens[0].tokens&&h.tokens[0].tokens.length>0&&h.tokens[0].tokens[0].type==="text"&&(h.tokens[0].tokens[0].text=$+" "+h.tokens[0].tokens[0].text)):h.tokens.unshift({type:"text",text:$+" "}):f+=$+" "}f+=this.parse(h.tokens,c),u+=this.renderer.listitem(f,x,!!p)}o+=this.renderer.list(u,s,l);continue}case"html":{const i=r;o+=this.renderer.html(i.text,i.block);continue}case"paragraph":{const i=r;o+=this.renderer.paragraph(this.parseInline(i.tokens));continue}case"text":{let i=r,s=i.tokens?this.parseInline(i.tokens):i.text;for(;a+1<e.length&&e[a+1].type==="text";)i=e[++a],s+=`
`+(i.tokens?this.parseInline(i.tokens):i.text);o+=t?this.renderer.paragraph(s):s;continue}default:{const i='Token with "'+r.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return o}parseInline(e,t){t=t||this.renderer;let o="";for(let a=0;a<e.length;a++){const r=e[a];if(this.options.extensions&&this.options.extensions.renderers&&this.options.extensions.renderers[r.type]){const i=this.options.extensions.renderers[r.type].call({parser:this},r);if(i!==!1||!["escape","html","link","image","strong","em","codespan","br","del","text"].includes(r.type)){o+=i||"";continue}}switch(r.type){case"escape":{const i=r;o+=t.text(i.text);break}case"html":{const i=r;o+=t.html(i.text);break}case"link":{const i=r;o+=t.link(i.href,i.title,this.parseInline(i.tokens,t));break}case"image":{const i=r;o+=t.image(i.href,i.title,i.text);break}case"strong":{const i=r;o+=t.strong(this.parseInline(i.tokens,t));break}case"em":{const i=r;o+=t.em(this.parseInline(i.tokens,t));break}case"codespan":{const i=r;o+=t.codespan(i.text);break}case"br":{o+=t.br();break}case"del":{const i=r;o+=t.del(this.parseInline(i.tokens,t));break}case"text":{const i=r;o+=t.text(i.text);break}default:{const i='Token with "'+r.type+'" type was not found.';if(this.options.silent)return console.error(i),"";throw new Error(i)}}}return o}}class he{constructor(e){w(this,"options");this.options=e||K}preprocess(e){return e}postprocess(e){return e}processAllTokens(e){return e}}w(he,"passThroughHooks",new Set(["preprocess","postprocess","processAllTokens"]));class lo{constructor(...e){Et(this,V);w(this,"defaults",Me());w(this,"options",this.setOptions);w(this,"parse",De(this,V,Qe).call(this,O.lex,I.parse));w(this,"parseInline",De(this,V,Qe).call(this,O.lexInline,I.parseInline));w(this,"Parser",I);w(this,"Renderer",$e);w(this,"TextRenderer",Ze);w(this,"Lexer",O);w(this,"Tokenizer",Te);w(this,"Hooks",he);this.use(...e)}walkTokens(e,t){var a,r;let o=[];for(const i of e)switch(o=o.concat(t.call(this,i)),i.type){case"table":{const s=i;for(const l of s.header)o=o.concat(this.walkTokens(l.tokens,t));for(const l of s.rows)for(const c of l)o=o.concat(this.walkTokens(c.tokens,t));break}case"list":{const s=i;o=o.concat(this.walkTokens(s.items,t));break}default:{const s=i;(r=(a=this.defaults.extensions)==null?void 0:a.childTokens)!=null&&r[s.type]?this.defaults.extensions.childTokens[s.type].forEach(l=>{const c=s[l].flat(1/0);o=o.concat(this.walkTokens(c,t))}):s.tokens&&(o=o.concat(this.walkTokens(s.tokens,t)))}}return o}use(...e){const t=this.defaults.extensions||{renderers:{},childTokens:{}};return e.forEach(o=>{const a={...o};if(a.async=this.defaults.async||a.async||!1,o.extensions&&(o.extensions.forEach(r=>{if(!r.name)throw new Error("extension name required");if("renderer"in r){const i=t.renderers[r.name];i?t.renderers[r.name]=function(...s){let l=r.renderer.apply(this,s);return l===!1&&(l=i.apply(this,s)),l}:t.renderers[r.name]=r.renderer}if("tokenizer"in r){if(!r.level||r.level!=="block"&&r.level!=="inline")throw new Error("extension level must be 'block' or 'inline'");const i=t[r.level];i?i.unshift(r.tokenizer):t[r.level]=[r.tokenizer],r.start&&(r.level==="block"?t.startBlock?t.startBlock.push(r.start):t.startBlock=[r.start]:r.level==="inline"&&(t.startInline?t.startInline.push(r.start):t.startInline=[r.start]))}"childTokens"in r&&r.childTokens&&(t.childTokens[r.name]=r.childTokens)}),a.extensions=t),o.renderer){const r=this.defaults.renderer||new $e(this.defaults);for(const i in o.renderer){if(!(i in r))throw new Error(`renderer '${i}' does not exist`);if(i==="options")continue;const s=i,l=o.renderer[s],c=r[s];r[s]=(...u)=>{let d=l.apply(r,u);return d===!1&&(d=c.apply(r,u)),d||""}}a.renderer=r}if(o.tokenizer){const r=this.defaults.tokenizer||new Te(this.defaults);for(const i in o.tokenizer){if(!(i in r))throw new Error(`tokenizer '${i}' does not exist`);if(["options","rules","lexer"].includes(i))continue;const s=i,l=o.tokenizer[s],c=r[s];r[s]=(...u)=>{let d=l.apply(r,u);return d===!1&&(d=c.apply(r,u)),d}}a.tokenizer=r}if(o.hooks){const r=this.defaults.hooks||new he;for(const i in o.hooks){if(!(i in r))throw new Error(`hook '${i}' does not exist`);if(i==="options")continue;const s=i,l=o.hooks[s],c=r[s];he.passThroughHooks.has(i)?r[s]=u=>{if(this.defaults.async)return Promise.resolve(l.call(r,u)).then(h=>c.call(r,h));const d=l.call(r,u);return c.call(r,d)}:r[s]=(...u)=>{let d=l.apply(r,u);return d===!1&&(d=c.apply(r,u)),d}}a.hooks=r}if(o.walkTokens){const r=this.defaults.walkTokens,i=o.walkTokens;a.walkTokens=function(s){let l=[];return l.push(i.call(this,s)),r&&(l=l.concat(r.call(this,s))),l}}this.defaults={...this.defaults,...a}}),this}setOptions(e){return this.defaults={...this.defaults,...e},this}lexer(e,t){return O.lex(e,t??this.defaults)}parser(e,t){return I.parse(e,t??this.defaults)}}V=new WeakSet,Qe=function(e,t){return(o,a)=>{const r={...a},i={...this.defaults,...r};this.defaults.async===!0&&r.async===!1&&(i.silent||console.warn("marked(): The async option was set to true by an extension. The async: false option sent to parse will be ignored."),i.async=!0);const s=De(this,V,qt).call(this,!!i.silent,!!i.async);if(typeof o>"u"||o===null)return s(new Error("marked(): input parameter is undefined or null"));if(typeof o!="string")return s(new Error("marked(): input parameter is of type "+Object.prototype.toString.call(o)+", string expected"));if(i.hooks&&(i.hooks.options=i),i.async)return Promise.resolve(i.hooks?i.hooks.preprocess(o):o).then(l=>e(l,i)).then(l=>i.hooks?i.hooks.processAllTokens(l):l).then(l=>i.walkTokens?Promise.all(this.walkTokens(l,i.walkTokens)).then(()=>l):l).then(l=>t(l,i)).then(l=>i.hooks?i.hooks.postprocess(l):l).catch(s);try{i.hooks&&(o=i.hooks.preprocess(o));let l=e(o,i);i.hooks&&(l=i.hooks.processAllTokens(l)),i.walkTokens&&this.walkTokens(l,i.walkTokens);let c=t(l,i);return i.hooks&&(c=i.hooks.postprocess(c)),c}catch(l){return s(l)}}},qt=function(e,t){return o=>{if(o.message+=`
Please report this to https://github.com/markedjs/marked.`,e){const a="<p>An error occurred:</p><pre>"+D(o.message+"",!0)+"</pre>";return t?Promise.resolve(a):a}if(t)return Promise.reject(o);throw o}};const Q=new lo;function y(n,e){return Q.parse(n,e)}y.options=y.setOptions=function(n){return Q.setOptions(n),y.defaults=Q.defaults,gt(y.defaults),y},y.getDefaults=Me,y.defaults=K,y.use=function(...n){return Q.use(...n),y.defaults=Q.defaults,gt(y.defaults),y},y.walkTokens=function(n,e){return Q.walkTokens(n,e)},y.parseInline=Q.parseInline,y.Parser=I,y.parser=I.parse,y.Renderer=$e,y.TextRenderer=Ze,y.Lexer=O,y.lexer=O.lex,y.Tokenizer=Te,y.Hooks=he,y.parse=y,y.options,y.setOptions,y.use,y.walkTokens,y.parseInline,I.parse,O.lex;var co=k('<div style="background:#ffffff;border-radius:6px;margin-bottom:8px;box-shadow:0px -2px 4px rgba(0,0,0,0.2);overflow:hidden;transition:opacity 0.2s"><div style="display:flex;justify-content:space-between;align-items:center;padding:10px 12px;cursor:pointer;user-select:none"><span style=font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px></span><div style=display:flex;gap:6px;align-items:center><span style=color:#aaaaaa;font-size:12px>'),uo=k('<span style="background:#ddd;color:#888;border-radius:3px;padding:2px 6px;font-size:9px;font-weight:700;letter-spacing:0.5px">USED'),ho=k('<span style="background:var(--sq-accent);color:#ffffff;border-radius:3px;padding:2px 8px;font-size:10px;font-weight:700;white-space:nowrap"> energy'),fo=k(`<div style="padding:0 12px 10px;color:#555555;font-size:13px;line-height:1.6;font-family:'Varela Round', 'Nunito', sans-serif">`);function po(n){return y.parse(n).replace(/\bD(\d+)\b/g,"<strong>D$1</strong>")}function go(n){const[e,t]=U(!1);function o(){var a;n.used?t(r=>!r):(n.onUse(),(a=n.onActivate)==null||a.call(n,n.card),t(!0))}return(()=>{var a=co(),r=a.firstChild,i=r.firstChild,s=i.nextSibling,l=s.firstChild;return r.$$click=o,g(i,()=>n.card.title),g(s,(()=>{var c=L(()=>!!n.used);return()=>c()?uo():L(()=>n.card.energyCost!==void 0)()&&(()=>{var u=ho(),d=u.firstChild;return g(u,()=>n.card.energyCost,d),u})()})(),l),g(l,()=>e()?"▲":"▼"),g(a,(()=>{var c=L(()=>!!e());return()=>c()&&(()=>{var u=fo();return S(()=>u.innerHTML=po(n.card.body)),u})()})(),null),S(c=>{var u=n.used?.55:1,d=n.used?"#999999":"var(--sq-accent)",h=n.used?"line-through":"none";return u!==c.e&&A(a,"opacity",c.e=u),d!==c.t&&A(i,"color",c.t=d),h!==c.a&&A(i,"text-decoration",c.a=h),c},{e:void 0,t:void 0,a:void 0}),a})()}Z(["click"]);var yo=k('<div style="background:#ffffff;border-radius:6px;margin-bottom:8px;box-shadow:0px -2px 4px rgba(0,0,0,0.2);overflow:hidden"><div style="display:flex;justify-content:space-between;align-items:center;padding:10px 12px;cursor:pointer;user-select:none"><span style=color:var(--sq-accent);font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:1px></span><span style=color:#aaaaaa;font-size:12px>'),mo=k(`<div style="padding:0 12px 10px;color:#555555;font-size:13px;line-height:1.6;font-family:'Varela Round', 'Nunito', sans-serif">`);function Ke(n){const[e,t]=U(!1);return(()=>{var o=yo(),a=o.firstChild,r=a.firstChild,i=r.nextSibling;return a.$$click=()=>t(s=>!s),g(r,()=>n.title),g(i,()=>e()?"▲":"▼"),g(o,(()=>{var s=L(()=>!!e());return()=>s()&&(()=>{var l=mo();return S(()=>l.innerHTML=y.parse(n.body)),l})()})(),null),o})()}Z(["click"]);var bo=k(`<div style="background:#ffffff;border-radius:6px;margin-bottom:8px;box-shadow:0px -2px 4px rgba(0,0,0,0.2);border-top:3px solid var(--sq-accent);overflow:hidden"><div style="padding:10px 12px 4px"><span style=color:var(--sq-accent);font-size:12px;font-weight:700;text-transform:uppercase;letter-spacing:1px>Am I Dead?</span></div><div style="padding:0 12px 12px;color:#555555;font-size:13px;line-height:1.6;font-family:'Varela Round', 'Nunito', sans-serif">`);function wo(n){return(()=>{var e=bo(),t=e.firstChild;t.firstChild;var o=t.nextSibling;return S(()=>o.innerHTML=y.parse(n.body)),e})()}var ko=k('<div style="padding:12px 14px">');function xo(n){const e=H(()=>n.abilities.filter(t=>{const o=t.source===n.charClass||t.source===n.profession||t.source==="general",a=t.context===n.combat;return o&&a}));return(()=>{var t=ko();return g(t,b(ae,{get when(){return L(()=>n.hp===0)()&&n.deathContent},get children(){return b(wo,{get body(){return n.deathContent}})}}),null),g(t,b(ae,{get when(){return L(()=>n.combat==="inGeneral")()&&!!n.descriptions[n.personality]},get children(){return b(Ke,{get title(){return n.personality},get body(){return n.descriptions[n.personality]}})}}),null),g(t,b(ae,{get when(){return L(()=>n.combat==="inGeneral")()&&!!n.descriptions[n.charClass]},get children(){return b(Ke,{get title(){return n.charClass},get body(){return n.descriptions[n.charClass]}})}}),null),g(t,b(ae,{get when(){return L(()=>n.combat==="inGeneral")()&&!!n.descriptions[n.profession]},get children(){return b(Ke,{get title(){return n.profession},get body(){return n.descriptions[n.profession]}})}}),null),g(t,b(W,{get each(){return e()},children:o=>b(go,{card:o,get used(){return n.usedCards.has(o.title)},onUse:()=>n.onUseCard(o.title),get onActivate(){return n.onActivate}})}),null),t})()}var vo=k('<div style="background:var(--sq-row-3);border-top:1px solid var(--sq-row-border);padding:8px 14px;display:flex;gap:10px;align-items:center;flex-wrap:wrap"><span style=color:var(--sq-overlay-text-muted);font-size:12px;text-transform:uppercase;letter-spacing:1px>GM</span><div style="width:36px;height:18px;border-radius:9px;cursor:pointer;position:relative;transition:background 0.2s;flex-shrink:0"><div style="width:14px;height:14px;background:#ffffff;border-radius:50%;position:absolute;top:1px;transition:left 0.2s"></div></div><button style="margin-left:auto;background:var(--sq-ctrl-bg);border:1px solid var(--sq-ctrl-border);color:var(--sq-overlay-text);border-radius:50%;width:24px;height:24px;font-size:13px;font-weight:700;font-family:inherit;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0">?'),_o=k('<button style="background:var(--sq-ctrl-bg);border:1px solid var(--sq-accent);color:var(--sq-accent);border-radius:4px;padding:3px 10px;font-size:12px;font-family:inherit">Save'),Co=k('<select style="background:var(--sq-ctrl-bg);border:1px solid var(--sq-ctrl-border);color:var(--sq-ctrl-text);border-radius:4px;padding:3px 8px;font-size:12px;font-family:inherit;cursor:pointer"><option value>Load character...'),To=k("<option>");function So(n){const e=()=>Object.keys(n.savedCharacters);return(()=>{var t=vo(),o=t.firstChild,a=o.nextSibling,r=a.firstChild,i=a.nextSibling;return a.$$click=()=>n.onToggle(!n.enabled),g(t,(()=>{var s=L(()=>!!n.enabled);return()=>s()&&[(()=>{var l=_o();return Oe(l,"click",n.onSave),S(c=>{var u=!n.characterName,d=n.characterName?"pointer":"not-allowed",h=n.characterName?"1":"0.4";return u!==c.e&&(l.disabled=c.e=u),d!==c.t&&A(l,"cursor",c.t=d),h!==c.a&&A(l,"opacity",c.a=h),c},{e:void 0,t:void 0,a:void 0}),l})(),(()=>{var l=Co();return l.firstChild,l.addEventListener("change",c=>{c.currentTarget.value&&n.onLoad(c.currentTarget.value),c.currentTarget.value=""}),g(l,b(W,{get each(){return e()},children:c=>(()=>{var u=To();return u.value=c,g(u,c),u})()}),null),l})()]})(),i),Oe(i,"click",n.onHelpOpen),S(s=>{var l=n.enabled?"var(--sq-accent)":"var(--sq-ctrl-bg)",c=`1px solid ${n.enabled?"var(--sq-accent)":"var(--sq-ctrl-border)"}`,u=n.enabled?"19px":"1px";return l!==s.e&&A(a,"background",s.e=l),c!==s.t&&A(a,"border",s.t=c),u!==s.a&&A(r,"left",s.a=u),s},{e:void 0,t:void 0,a:void 0}),t})()}Z(["click"]);var Ro=k(`<div style=position:absolute;inset:0;background:#ffffff;z-index:500;overflow:auto;padding:16px><div style=display:flex;justify-content:space-between;align-items:center;margin-bottom:12px><span style=color:var(--sq-accent);font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:1px>General Rules</span><button style=background:var(--sq-accent);color:#ffffff;border:none;border-radius:50%;width:28px;height:28px;font-size:16px;font-weight:700;font-family:inherit;cursor:pointer;display:flex;align-items:center;justify-content:center;flex-shrink:0>×</button></div><div style="color:#3f3e4a;font-size:13px;line-height:1.7;font-family:'Varela Round', 'Nunito', sans-serif">`);function Ao(n){return(()=>{var e=Ro(),t=e.firstChild,o=t.firstChild,a=o.nextSibling,r=t.nextSibling;return Oe(a,"click",n.onClose),S(()=>r.innerHTML=y.parse(n.body)),e})()}Z(["click"]);const $o='@import"https://fonts.googleapis.com/css2?family=Varela+Round&family=Nunito:wght@400;600;700&display=swap";/*! tailwindcss v4.2.4 | MIT License | https://tailwindcss.com */@layer properties{@supports (((-webkit-hyphens:none)) and (not (margin-trim:inline))) or ((-moz-orient:inline) and (not (color:rgb(from red r g b)))){*,:before,:after,::backdrop{--tw-rotate-x:initial;--tw-rotate-y:initial;--tw-rotate-z:initial;--tw-skew-x:initial;--tw-skew-y:initial;--tw-border-style:solid;--tw-ordinal:initial;--tw-slashed-zero:initial;--tw-numeric-figure:initial;--tw-numeric-spacing:initial;--tw-numeric-fraction:initial;--tw-shadow:0 0 #0000;--tw-shadow-color:initial;--tw-shadow-alpha:100%;--tw-inset-shadow:0 0 #0000;--tw-inset-shadow-color:initial;--tw-inset-shadow-alpha:100%;--tw-ring-color:initial;--tw-ring-shadow:0 0 #0000;--tw-inset-ring-color:initial;--tw-inset-ring-shadow:0 0 #0000;--tw-ring-inset:initial;--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-offset-shadow:0 0 #0000;--tw-outline-style:solid;--tw-blur:initial;--tw-brightness:initial;--tw-contrast:initial;--tw-grayscale:initial;--tw-hue-rotate:initial;--tw-invert:initial;--tw-opacity:initial;--tw-saturate:initial;--tw-sepia:initial;--tw-drop-shadow:initial;--tw-drop-shadow-color:initial;--tw-drop-shadow-alpha:100%;--tw-drop-shadow-size:initial;--tw-backdrop-blur:initial;--tw-backdrop-brightness:initial;--tw-backdrop-contrast:initial;--tw-backdrop-grayscale:initial;--tw-backdrop-hue-rotate:initial;--tw-backdrop-invert:initial;--tw-backdrop-opacity:initial;--tw-backdrop-saturate:initial;--tw-backdrop-sepia:initial}}}@layer theme{:root,:host{--font-sans:ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji";--font-mono:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace;--color-red-900:oklch(39.6% .141 25.723);--spacing:.25rem;--default-transition-duration:.15s;--default-transition-timing-function:cubic-bezier(.4, 0, .2, 1);--default-font-family:var(--font-sans);--default-mono-font-family:var(--font-mono)}}@layer base{*,:after,:before,::backdrop{box-sizing:border-box;border:0 solid;margin:0;padding:0}::file-selector-button{box-sizing:border-box;border:0 solid;margin:0;padding:0}html,:host{-webkit-text-size-adjust:100%;-moz-tab-size:4;tab-size:4;line-height:1.5;font-family:var(--default-font-family,ui-sans-serif, system-ui, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji");font-feature-settings:var(--default-font-feature-settings,normal);font-variation-settings:var(--default-font-variation-settings,normal);-webkit-tap-highlight-color:transparent}hr{height:0;color:inherit;border-top-width:1px}abbr:where([title]){-webkit-text-decoration:underline dotted;text-decoration:underline dotted}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;-webkit-text-decoration:inherit;text-decoration:inherit}b,strong{font-weight:bolder}code,kbd,samp,pre{font-family:var(--default-mono-font-family,ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", "Courier New", monospace);font-feature-settings:var(--default-mono-font-feature-settings,normal);font-variation-settings:var(--default-mono-font-variation-settings,normal);font-size:1em}small{font-size:80%}sub,sup{vertical-align:baseline;font-size:75%;line-height:0;position:relative}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit;border-collapse:collapse}:-moz-focusring{outline:auto}progress{vertical-align:baseline}summary{display:list-item}ol,ul,menu{list-style:none}img,svg,video,canvas,audio,iframe,embed,object{vertical-align:middle;display:block}img,video{max-width:100%;height:auto}button,input,select,optgroup,textarea{font:inherit;font-feature-settings:inherit;font-variation-settings:inherit;letter-spacing:inherit;color:inherit;opacity:1;background-color:#0000;border-radius:0}::file-selector-button{font:inherit;font-feature-settings:inherit;font-variation-settings:inherit;letter-spacing:inherit;color:inherit;opacity:1;background-color:#0000;border-radius:0}:where(select:is([multiple],[size])) optgroup{font-weight:bolder}:where(select:is([multiple],[size])) optgroup option{padding-inline-start:20px}::file-selector-button{margin-inline-end:4px}::placeholder{opacity:1}@supports (not ((-webkit-appearance:-apple-pay-button))) or (contain-intrinsic-size:1px){::placeholder{color:currentColor}@supports (color:color-mix(in lab,red,red)){::placeholder{color:color-mix(in oklab,currentcolor 50%,transparent)}}}textarea{resize:vertical}::-webkit-search-decoration{-webkit-appearance:none}::-webkit-date-and-time-value{min-height:1lh;text-align:inherit}::-webkit-datetime-edit{display:inline-flex}::-webkit-datetime-edit-fields-wrapper{padding:0}::-webkit-datetime-edit{padding-block:0}::-webkit-datetime-edit-year-field{padding-block:0}::-webkit-datetime-edit-month-field{padding-block:0}::-webkit-datetime-edit-day-field{padding-block:0}::-webkit-datetime-edit-hour-field{padding-block:0}::-webkit-datetime-edit-minute-field{padding-block:0}::-webkit-datetime-edit-second-field{padding-block:0}::-webkit-datetime-edit-millisecond-field{padding-block:0}::-webkit-datetime-edit-meridiem-field{padding-block:0}::-webkit-calendar-picker-indicator{line-height:1}:-moz-ui-invalid{box-shadow:none}button,input:where([type=button],[type=reset],[type=submit]){-webkit-appearance:button;-moz-appearance:button;appearance:button}::file-selector-button{-webkit-appearance:button;-moz-appearance:button;appearance:button}::-webkit-inner-spin-button{height:auto}::-webkit-outer-spin-button{height:auto}[hidden]:where(:not([hidden=until-found])){display:none!important}}@layer components;@layer utilities{.invisible{visibility:hidden}.visible{visibility:visible}.absolute{position:absolute}.fixed{position:fixed}.relative{position:relative}.static{position:static}.sticky{position:sticky}.start{inset-inline-start:var(--spacing)}.end{inset-inline-end:var(--spacing)}.isolate{isolation:isolate}.order-0,.order-none{order:0}.container{width:100%}@media(min-width:40rem){.container{max-width:40rem}}@media(min-width:48rem){.container{max-width:48rem}}@media(min-width:64rem){.container{max-width:64rem}}@media(min-width:80rem){.container{max-width:80rem}}@media(min-width:96rem){.container{max-width:96rem}}.\\!hidden{display:none!important}.block{display:block}.contents{display:contents}.flex{display:flex}.grid{display:grid}.hidden{display:none}.inline{display:inline}.inline-block{display:inline-block}.table{display:table}.table-caption{display:table-caption}.table-cell{display:table-cell}.flex-shrink{flex-shrink:1}.flex-grow,.grow{flex-grow:1}.border-collapse{border-collapse:collapse}.transform{transform:var(--tw-rotate-x,) var(--tw-rotate-y,) var(--tw-rotate-z,) var(--tw-skew-x,) var(--tw-skew-y,)}.resize{resize:both}.flex-wrap{flex-wrap:wrap}.truncate{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.rounded{border-radius:.25rem}.border{border-style:var(--tw-border-style);border-width:1px}.mask-repeat{-webkit-mask-repeat:repeat;mask-repeat:repeat}.text-wrap{text-wrap:wrap}.break-words,.wrap-break-word{overflow-wrap:break-word}.capitalize{text-transform:capitalize}.lowercase{text-transform:lowercase}.uppercase{text-transform:uppercase}.italic{font-style:italic}.ordinal{--tw-ordinal:ordinal;font-variant-numeric:var(--tw-ordinal,) var(--tw-slashed-zero,) var(--tw-numeric-figure,) var(--tw-numeric-spacing,) var(--tw-numeric-fraction,)}.line-through{text-decoration-line:line-through}.underline{text-decoration-line:underline}.shadow{--tw-shadow:0 1px 3px 0 var(--tw-shadow-color,#0000001a), 0 1px 2px -1px var(--tw-shadow-color,#0000001a);box-shadow:var(--tw-inset-shadow),var(--tw-inset-ring-shadow),var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow)}.outline{outline-style:var(--tw-outline-style);outline-width:1px}.blur{--tw-blur:blur(8px);filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.grayscale{--tw-grayscale:grayscale(100%);filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.invert{--tw-invert:invert(100%);filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.sepia{--tw-sepia:sepia(100%);filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.\\!filter{filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)!important}.filter{filter:var(--tw-blur,) var(--tw-brightness,) var(--tw-contrast,) var(--tw-grayscale,) var(--tw-hue-rotate,) var(--tw-invert,) var(--tw-saturate,) var(--tw-sepia,) var(--tw-drop-shadow,)}.backdrop-filter{-webkit-backdrop-filter:var(--tw-backdrop-blur,) var(--tw-backdrop-brightness,) var(--tw-backdrop-contrast,) var(--tw-backdrop-grayscale,) var(--tw-backdrop-hue-rotate,) var(--tw-backdrop-invert,) var(--tw-backdrop-opacity,) var(--tw-backdrop-saturate,) var(--tw-backdrop-sepia,);backdrop-filter:var(--tw-backdrop-blur,) var(--tw-backdrop-brightness,) var(--tw-backdrop-contrast,) var(--tw-backdrop-grayscale,) var(--tw-backdrop-hue-rotate,) var(--tw-backdrop-invert,) var(--tw-backdrop-opacity,) var(--tw-backdrop-saturate,) var(--tw-backdrop-sepia,)}.transition{transition-property:color,background-color,border-color,outline-color,text-decoration-color,fill,stroke,--tw-gradient-from,--tw-gradient-via,--tw-gradient-to,opacity,box-shadow,transform,translate,scale,rotate,filter,-webkit-backdrop-filter,backdrop-filter,display,content-visibility,overlay,pointer-events;transition-timing-function:var(--tw-ease,var(--default-transition-timing-function));transition-duration:var(--tw-duration,var(--default-transition-duration))}.data-\\[personality\\=passionate\\]\\:bg-red-900[data-personality=passionate]{background-color:var(--color-red-900)}}:host{font-family:var(--sq-font-family,"Varela Round", "Nunito", sans-serif);--sq-bg:#888;--sq-accent:#888;--sq-overlay-text:#fffffff2;--sq-overlay-text-muted:#ffffff8c;--sq-ctrl-bg:#ffffff26;--sq-ctrl-border:#ffffff4d;--sq-ctrl-text:#fffffff2;--sq-row-1:#00000026;--sq-row-2:#0000001a;--sq-row-3:#0003;--sq-row-border:#0000001f;--sq-dot-empty-bg:#fff3;--sq-dot-empty-border:#fff6;background-color:var(--sq-bg);color:#3f3e4a;display:block}:host([data-personality=passionate]){--sq-bg:#943a11;--sq-accent:#943a11}:host([data-personality=calculating]){--sq-bg:#26869d;--sq-accent:#26869d}:host([data-personality=wild]){--sq-bg:#758d2c;--sq-accent:#758d2c}:host([data-personality=selfish]){--sq-bg:#3f3e4a;--sq-accent:#3f3e4a}:host([data-personality=righteous]){--sq-bg:#daceae;--sq-accent:#5a5060;--sq-overlay-text:#5a5060;--sq-overlay-text-muted:#5a506080;--sq-ctrl-bg:#0000000f;--sq-ctrl-border:#5a506040;--sq-ctrl-text:#5a5060;--sq-row-1:#0000000f;--sq-row-2:#0000000a;--sq-row-3:#00000014;--sq-row-border:#5a506026;--sq-dot-empty-bg:#5a50601f;--sq-dot-empty-border:#5a506040}.die-inline{color:#26869d;cursor:pointer;border-bottom:1px solid #26869d;font-weight:700}@property --tw-rotate-x{syntax:"*";inherits:false}@property --tw-rotate-y{syntax:"*";inherits:false}@property --tw-rotate-z{syntax:"*";inherits:false}@property --tw-skew-x{syntax:"*";inherits:false}@property --tw-skew-y{syntax:"*";inherits:false}@property --tw-border-style{syntax:"*";inherits:false;initial-value:solid}@property --tw-ordinal{syntax:"*";inherits:false}@property --tw-slashed-zero{syntax:"*";inherits:false}@property --tw-numeric-figure{syntax:"*";inherits:false}@property --tw-numeric-spacing{syntax:"*";inherits:false}@property --tw-numeric-fraction{syntax:"*";inherits:false}@property --tw-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-shadow-color{syntax:"*";inherits:false}@property --tw-shadow-alpha{syntax:"<percentage>";inherits:false;initial-value:100%}@property --tw-inset-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-inset-shadow-color{syntax:"*";inherits:false}@property --tw-inset-shadow-alpha{syntax:"<percentage>";inherits:false;initial-value:100%}@property --tw-ring-color{syntax:"*";inherits:false}@property --tw-ring-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-inset-ring-color{syntax:"*";inherits:false}@property --tw-inset-ring-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-ring-inset{syntax:"*";inherits:false}@property --tw-ring-offset-width{syntax:"<length>";inherits:false;initial-value:0}@property --tw-ring-offset-color{syntax:"*";inherits:false;initial-value:#fff}@property --tw-ring-offset-shadow{syntax:"*";inherits:false;initial-value:0 0 #0000}@property --tw-outline-style{syntax:"*";inherits:false;initial-value:solid}@property --tw-blur{syntax:"*";inherits:false}@property --tw-brightness{syntax:"*";inherits:false}@property --tw-contrast{syntax:"*";inherits:false}@property --tw-grayscale{syntax:"*";inherits:false}@property --tw-hue-rotate{syntax:"*";inherits:false}@property --tw-invert{syntax:"*";inherits:false}@property --tw-opacity{syntax:"*";inherits:false}@property --tw-saturate{syntax:"*";inherits:false}@property --tw-sepia{syntax:"*";inherits:false}@property --tw-drop-shadow{syntax:"*";inherits:false}@property --tw-drop-shadow-color{syntax:"*";inherits:false}@property --tw-drop-shadow-alpha{syntax:"<percentage>";inherits:false;initial-value:100%}@property --tw-drop-shadow-size{syntax:"*";inherits:false}@property --tw-backdrop-blur{syntax:"*";inherits:false}@property --tw-backdrop-brightness{syntax:"*";inherits:false}@property --tw-backdrop-contrast{syntax:"*";inherits:false}@property --tw-backdrop-grayscale{syntax:"*";inherits:false}@property --tw-backdrop-hue-rotate{syntax:"*";inherits:false}@property --tw-backdrop-invert{syntax:"*";inherits:false}@property --tw-backdrop-opacity{syntax:"*";inherits:false}@property --tw-backdrop-saturate{syntax:"*";inherits:false}@property --tw-backdrop-sepia{syntax:"*";inherits:false}';var Do=k("<style>"),Eo=k("<div style=height:100%;display:flex;flex-direction:column;overflow:hidden;position:relative><div style=flex:1;overflow-y:auto;min-height:0>");function qo(n){const{state:e,setState:t,setEnergy:o,loadFromStorage:a,saveCharacter:r,loadCharacter:i}=pn(),[s,l]=U(!1),[c,u]=U(new Set),d=H(()=>{if(!n.content)return null;try{return JSON.parse(n.content)}catch{return null}});It(()=>{a()}),te(()=>{if(n.character)try{const p=JSON.parse(n.character);t({...p})}catch{}}),te(Ot(()=>e.round,()=>{u(new Set)},{defer:!0}));function h(p){p.energyCost!==void 0&&n.element.dispatchEvent(new CustomEvent("abilityactivate",{detail:{title:p.title,energyCost:p.energyCost},bubbles:!0,composed:!0}))}return te(()=>{e.personality?n.element.setAttribute("data-personality",e.personality):n.element.removeAttribute("data-personality")}),te(()=>{n.element.dispatchEvent(new CustomEvent("characterchange",{detail:{name:e.name,class:e.class,profession:e.profession,personality:e.personality,die:e.die},bubbles:!0,composed:!0}))}),[(()=>{var p=Do();return g(p,$o),p})(),(()=>{var p=Eo(),x=p.firstChild;return g(p,b(vn,{get hp(){return e.hp},get energy(){return e.energy},get name(){return e.name},get charClass(){return e.class},get profession(){return e.profession},get personality(){return e.personality},onHpChange:f=>t("hp",f),onEnergyClick:o}),x),g(p,b(Tn,{get name(){return e.name},get personality(){return e.personality},get charClass(){return e.class},get profession(){return e.profession},get personalities(){var f;return((f=d())==null?void 0:f.personalities)??[]},get classes(){var f;return((f=d())==null?void 0:f.classes)??[]},get professions(){var f;return((f=d())==null?void 0:f.professions)??[]},onNameChange:f=>t("name",f),onPersonalityChange:f=>t("personality",f),onClassChange:f=>t("class",f),onProfessionChange:f=>t("profession",f)}),x),g(p,b(An,{get combat(){return e.combat},get statuses(){var f;return((f=d())==null?void 0:f.statuses)??[]},onChange:f=>t("combat",f)}),x),g(x,b(xo,{get abilities(){var f;return((f=d())==null?void 0:f.abilities)??[]},get descriptions(){var f;return((f=d())==null?void 0:f.descriptions)??{}},get deathContent(){var f;return((f=d())==null?void 0:f.deathContent)??""},get charClass(){return e.class},get profession(){return e.profession},get personality(){return e.personality},get combat(){return e.combat},get hp(){return e.hp},get usedCards(){return c()},onUseCard:f=>u($=>new Set([...$,f])),onActivate:h}),null),g(x,b(So,{get enabled(){return e.gmMode},get characterName(){return e.name},get savedCharacters(){return e.savedCharacters},onToggle:f=>t("gmMode",f),onSave:r,onLoad:i,onHelpOpen:()=>l(!0)}),null),g(p,b(ae,{get when(){return s()},get children(){return b(Ao,{get body(){var f;return((f=d())==null?void 0:f.generalContent)??""},onClose:()=>l(!1)})}}),null),p})()]}const zo={personalities:["passionate","wild","calculating","righteous","selfish"],classes:["wizard","sage","fighter","marksman","monk"],professions:["animal-trainer","criminal","diplomat","merchant","performer","priest","scout","soldier","tinkerer","warlock"],statuses:[{id:"inGeneral",label:"General",message:"Standard rules apply."},{id:"inCombat",label:"In Combat",message:"Combat is active. Initiative counts."},{id:"outOfCombat",label:"Out of Combat",message:"No enemies nearby."}],descriptions:{passionate:`"My name is Inigo Montoya. You killed my father. Prepare to die."
...
Fire in combat does 2 damage to adjacent enemies or players if they END their turn adjacent to it. Standing in fire does 3 damage. Fire can spread in flammable areas.`,deathContent:`Not really. Your character is still alive, but a couple things have happened:
...
If the flame lands ON an enemy, they take 4 damage. NEXT TO an enemy: 1 damage. The flame remains for the encounter and damages friend and foe alike.`,abilities:[{title:"Rest",body:"Spend 10 minutes resting to recover **D6** energy. You may not rest in combat.",context:"inGeneral",source:"general"},{title:"Assist",body:"Help an ally with their action. They add **D4** to their roll.",context:"inGeneral",source:"general"},{title:"Wand",body:`Attack an enemy with a ranged magic blast.
...
Your tinkerer can keep up to 2 successfully created machines to use later. Every time you use the machine, roll a D6 — if you roll a 1, it breaks.`,context:"outOfCombat",source:"tinkerer"},{title:"Analyze Undead",body:`Learn the weaknesses of any undead (skeleton, zombie, vampire, etc.) enemy. Can only be performed ONCE per enemy type.
...
* _20_ Your spirit friend will aid you in an upcoming battle. It is a non-elite NPC that takes verbal instructions on its turn from you.`,context:"outOfCombat",source:"warlock"}]};return sn("simple-quest",{content:"",character:""},(n,{element:e})=>b(qo,{get content(){return n.content},get character(){return n.character},element:e}),{shadow:!0}),_.sampleContent=zo,Object.defineProperty(_,Symbol.toStringTag,{value:"Module"}),_})({});
